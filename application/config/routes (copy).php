...
$route['best-'.$service.'-companies-in-'.$country] = 'Home/search/'.$ind->industryId.'/'.$ser->id.'/'.$count->id;
$route['best-'.$service.'-companies'] = 'Home/search/industry/'.$ser->id.'/country';
$route['best-'.$service.'-companies-in-'.$country] = 'Home/search/industry/'.$ser->id.'/'.$count->id;
$route['best-'.$indu.'-'.$service.'-companies'] = 'Home/search/'.$ind->industryId.'/'.$ser->id.'/country';
$route['best-'.$indu.'-'.$service.'-companies-in-'.$country] = 'Home/search/'.$ind->industryId.'/'.$ser->id.'/'.$count->id;
$route['best-'.$indu.'-companies'] = 'Home/search/'.$ind->industryId.'/service/country';
$route[$country.'/best-'.$service.'-companies'] = 'Home/search/industry/'.$ser->id.'/'.$count->id;
