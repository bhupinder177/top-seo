        ...
        <li>
            <div class="form-group">
                ...
                <select id="service" ng-model="service" class="form-control">
                    ...
                    <option value="{{ x.name | underscoreless | lowercase }}" ng-repeat="(key,x) in allservice" ng-init="allservice = key" value="{{ key }}">{{ x.name }}</option>


                </select>
                <p ng-cloak ng-show="searchv && service == ''" class="text-danger">Please select service.</p>
        ...
        <li>
            <div class="form-group">
                ...
                <select id="country" ng-model="country" class="form-control">
                    ...
                    <option value="{{ x.name | lowercase | underscoreless }}" ng-repeat="(key,x) in allcountry" ng-init="allcountry = key" value="{{ x.name | underscoreless | lowercase }}">{{ x.name }}</option>
    ...
    <div class="container-fluid">
                ...
                <li>
                    <div class="form-group">
                        ...
                        <select onchange="angular.element(this).scope().country1(this)" class="form-control">
                            ...
                            <option data-id='0' value='101'>Any Country</option>
                ...
                <li>
                    <div class="form-group">
                        ...
                        <select id="service" onchange="angular.element(this).scope().getservice(this)" class="form-control">
                            ...
                            <option data-id='0' value='0'>Any Service</option>
        ...
        <div class="freelancerphp freelance-bx" id="top-freelancer">
            ...
            <div class="free-bx">
                <div class="boxtopbar">
                    <span class="hour">
                        <?php echo $res->maxPrice; ?><em>/hr</em></span>
                    <?php
                                  if($res->company_logo != '')
                                  {
                                    ?>
                    ...
                    <?php if($res->type == 2 && $res->parent == 0)
                                  {
                                    ...
                                    ?>
                    <a href="<?php echo base_url(); ?><?php echo $clink; ?>" class="btn btn-primary">View Profile</a>
                    <?php
                                  }
                                  else if($res->type == 3 && $res->parent == 0)
                                  {
                                    ...
                                    ?>
                    <a href="<?php echo base_url(); ?><?php echo $flink; ?>" class="btn btn-primary">View Profile</a>
                    <?php
                                  }
                                  else if($res->type == 3 && $res->parent != 0)
                                  {
        ...
        <div style="display:none" class="freelancerangular freelance-bx">
            <div ng-if="results.length != 0" class="free-bx" ng-repeat="(key,x) in results" ng-init="results = key">
                <div class="boxtopbar">
                    <span class="hour">{{ x.maxPrice }}<em>/hr</em></span>
                ...
                <div class="btns" style="margin-top: 8px;">
                    ...
                    <a ng-if="x.type == 2 && x.parent == 0" href="<?php echo base_url(); ?>{{ x.c_name | lowercase | underscoreless }}-{{ x.u_id }}" class="btn btn-primary">View Profile</a>
                    <a ng-if="x.type == 3 && x.parent == 0" href="<?php echo base_url(); ?>{{ x.name | lowercase | underscoreless }}-{{ x.u_id }}" class="btn btn-primary">View Profile</a>
                    <a ng-if="x.type == 3 && x.parent != 0" href="<?php echo base_url(); ?>{{ x.company_link | lowercase | underscoreless }}-{{ x.parent }}" class="btn btn-primary">View Profile</a>
        ...
        <div class="col-md-12">
          <div class="blog-m-bx">
            <div class="row">
              ...
              <div class="col-md-4">
                  <div class="blog-bx">
              <a href="<?php echo base_url().$link; ?>">  <img height="200" width="350" src="<?php echo base_url(); ?>assets/blog/<?php echo $b->image; ?>"></a>
              <h1><a href="<?php echo base_url().$link; ?>"><?php echo ucwords($b->title); ?></a></h1>
              <span><?php echo $b->category; ?></span>
              <p><?php echo substr($b->description, 0, 270);  ?></p>
                      <a href="<?php echo base_url().$link;?>" class="read-more">Read more</a>
