...
<div id="wrapper" class="content-wrapper">
	...
	<section class="content portfolio-cont bg-white" ng-app="myApp16" ng-controller="myCtrt16">
		<!-- get sidebar -->
			<div id="content">
				<!-- content -->
				<div ng-cloak class="box box-success" >
					<div class="box-body">
							...
							<th class="text-center">Gig Title</th>
							...
							<td class="text-center"><a target="_blank" href="<?php echo base_url(); ?>client-gigdetail/{{ x.user_gig_buyId }}" class="btn btn-primary">Details</a></td>
