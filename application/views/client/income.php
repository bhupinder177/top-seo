...
<div id="wrapper" class="content-wrapper">
  ...
  <section class="content income">
    <div class=" no-margin user-dashboard-container">
      <div ng-cloak  ng-app="myApp19" ng-controller="myCtrt19">
        <div id="content">
                    ...
                    <div class="col-md-2">
                     <div class="form-group sea-cstm">
                       <input  ng-click="searchdate()" type="button" value="search" class="btn btn-info" >
                            ...
                            <div ng-if="advanceSearchshow == 1" class="col-md-2">
                              <div class="form-group sea-cstm">
                                <input  ng-click="getMonthIncome()" type="button" value="Search" class="btn btn-success w-100" >
                              </div>
                            </div>
                  ...
                  <div ng-if="show == 0" class="box-body bg-white mt-3 pb-2">
                    ...
                    <table   id="rankingTable" class="table">
                      <thead>
                        ...
                        <th>Amount</th>
                        <th>Status</th>
                        <th>Received Amount({{ getuserlocalcurrency.code }} {{ getuserlocalcurrency.symbol  }})</th>
                      ...
                      <tbody>
                        <tr ng-if="currentIn.length != 0" ng-repeat="(key,x) in currentIn" >
                          ...
                          <td>
                            <input ng-disabled="x.disabled" ng-if="x.receivedAmount" ng-keyup="receivedkeyup($event.target.value,x.incomeId)" class="form-control col-md-4" ng-model="x.receivedAmount" ng-value="x.receivedAmount" >
                          </td>
                        ...
                        <tr ng-if="currentIn.length == 0"><td>No Record found</td></tr>
                      </tbody>
                     ...
                     <h4 ng-if="Totalreceived != 0">Total Received Amount: {{ getuserlocalcurrency.code }} {{ getuserlocalcurrency.symbol  }} {{ Totalreceived | number }}.00</h4>
                    ...
                    <div ng-cloak class="box-body action-cstm bg-white mt-3">
                        ...
                        <tbody>
                          <tr ng-if="monthEx.length != 0 " ng-repeat="(key,x) in monthEx" >
                            ...
                            <td>{{ x.project }}</td>
                              <td>{{ x.date | date2 }}</td>
                              <td>{{ x.code }} {{ x.symbol }} {{ x.amount | number }}</td>
                              <td><span ng-if="x.receivedAmount">{{ getuserlocalcurrency.code }} {{ getuserlocalcurrency.symbol  }} {{ x.receivedAmount | number }}</span></td>
                            <td>
                              <select onchange="angular.element(this).scope().changeStatus(this)" type="text"  class="form-control rounded-0" ng-model="x.status"  id="status">
                              <option data-id="0"  value=" ">Select Status</option>
                              <option ng-if="x.receivedAmount > 0" data-id="{{ x.incomeId }}" value="1">Received</option>
                              <option ng-if="x.amount != x.receivedAmount && x.receivedAmount != 0"  data-id="{{ x.incomeId }}" value="2">Pending</option>
                            </select>
                            </td>
                            <td>
                                <div class="dropdown ac-cstm text-right">
                      ...
                      <h4 ng-if="monthreceived != 0">Total Received Amount: {{ getuserlocalcurrency.code }} {{ getuserlocalcurrency.symbol  }} {{ monthreceived | number }}.00</h4>
                      </div>
                        ...
                        <div class="modal-content">
                          ...
                          <p ng-show="submitl && currency1 == ''" class="text-danger">Please select currency.</p>
                            ...
                            <div class="form-group">
                              ...
                              <select type="text"  class="form-control rounded-0" onchange="angular.element(this).scope().changedStatus(this)" ng-model="status1"  id="status">
                              <option value="">Select Status</option>
                              <option value="1">Received</option>
                              <option value="2">Pending</option>
                            </select>
                            ...
                            <div class="form-group">
                              ...
                              <label for="position" class="m-0">Received From<span class="red-text">*</span></label>
                              <select ng-disabled="disabled" type="text"  class="form-control rounded-0" ng-model="received1"  id="received">
                              <option value="">Select Received from</option>
                              <option value="1">Bank</option>
                              <option value="2">PayPal</option>
                              <option value="3">Upwork</option>
                            ...
                            <div class="form-group">
                              ...
                              <select ng-disabled="disabled" type="text"  class="form-control rounded-0" ng-model="deposited1"  id="deposited1">
                              <option value="">Select Deposited in</option>
                              <option value="1">Bank</option>
                              <option value="2">Cash</option>
                              <option value="3">Other</option>
                            ...
                            <div class="form-group ">
                              ...
                              <input ng-disabled="disabled" id="receivedamount1" class="form-control numberdecimalonly" name="Receivedamount" ng-model="Receivedamount1" ng-value="Receivedamount1" placeholder="Please enter received amount">
