...
<div id="wrapper" class="content-wrapper">
    ...
    <section class="box p-3">
        <div class="profile-preview profile-container"> 
            <!-- chat --> 
            <div ng-cloak ng-cloak ng-app="myApp12" ng-controller="myCtrt12" id="chatcontroller" class="">
                    ...
                    <div class="message_write"> 
                        ...
                        <div class="chat_bottom"> 
                          ...
                          <input onchange="angular.element(this).scope().chatAttachment(this)" type="file" name="attchment" class="form-control">
                            ...
                            <button type="button" ng-show="person[selectedContact]['fid'] != userId" ng-click="sendmessage(person[selectedContact]['fid'],person[selectedContact]['fname'],person[selectedContact]['friendId'])" scroll-bottom="bottom" class="pull-right btn btn-success">
                                Send</button> 
                        </div>
                        </div>
                    </div>  
