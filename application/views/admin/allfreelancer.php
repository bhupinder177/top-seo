...
<div id="wrapper" class="content-wrapper">
   ...
   <!--main-container-part-->
   <section class="content1 custom-das">
      <!-- get sidebar -->
      <div id="content">
         <div class="content-box no-border-radius">
            <!-- content -->
            <div ng-cloak class="box box-success" ng-app="myApp1" ng-controller="myCtrt1">
               <div class="box-header with-border p-3">
                  <h4 class="box-title">All Companies</h4>
                  <div class="row">
               ...
               <div class="box-body">
                  <div class="table-responsive">
                     <table class="table">
                        ...
                        <tbody>
                           <tr ng-if="freelancers.length != 0" ng-repeat="(key,x) in freelancers" ng-init="freelancers = key">
                              <td>{{ x.c_name }} </td>
                              <td>
                              ...
                              <td>
                                 ...
                                 <a ng-click="userStatus(0,key,x.u_id)" ng-if="x.is_active == 1" class="btn btn btn-success">Active</a>
                              </td>
                              <td class="action-btns">
                                 <div class="dropdown ac-cstm text-right">
                                    ...
                                    <div class="dropdown-menu fadeIn">
                                       ...
                                       <a class="dropdown-item" ng-if="x.parent == 0" title="Services" href="<?php echo base_url(); ?>admin/freelancerServices/{{ x.u_id }}"><i class="fa fa-fw fa-edit"></i>service</a>
                                       <a class="dropdown-item" ng-if="x.parent == 0" title="Edit Profile" href="<?php echo base_url(); ?>admin/freelanceredit/{{ x.u_id }}"><i class="fa fa-fw fa-edit"></i>Edit Profile</a>
                                       <!-- <a class="dropdown-item" ng-click="confirm(key,x.u_id)" title="Delete"><i class="fa fa-trash"></i> Delete</a> -->
                                    </div>
                                 </div>
                              </td>
                           </tr>
