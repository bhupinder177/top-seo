  ...
  <div id="wrapper" class="content-wrapper">
    ...
    <section class="content-header"> 
      <ol class="breadcrumb">
        ...
        <li class="active">Freelancer jobs</li>
      </ol>
    </section>
...
<section class="content">   
	<!-- get sidebar --> 
		<div class="no-margin user-dashboard-container"> 
				<div id="content"> 
					<div id="content-header"> 
						<div id="breadcrumb"> 
							...
							<a href="<?php echo base_url(); ?>" class="current">Jobs</a> 
						</div> 
					</div> 
			 ...
			 <div ng-cloak class="box box-success" ng-app="myApp4" ng-controller="myCtrt4"> 
								 ...
								 <tr ng-if="jobs.length != 0" ng-repeat="(key,x) in jobs" ng-init="jobs = key">
									 ...
									 <td> <a href="<?php echo base_url(); ?>{{ x.jobTitle | lowercase | underscoreless }}-{{ x.jobId }}">{{ x.jobTitle }}</a></td>
									  <td>{{ x.jobDescription }}</td>
										<td>{{  x.jobAmount  }} </td>
										 <td>{{ x.name }}</td>
										 <td ng-if="x.contractStatus == 1"><a class="btn btn-primary">Pending</a> </td>
										 <td ng-if="x.contractStatus == 2"><a class="btn btn-success">Completed</a></td>
