...
<div id="wrapper" class="content-wrapper">
  ...
  <section ng-cloak  ng-app="myApp41" ng-controller="myCtrt41"  class="content">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="form-group">
                     <label>Portfolio <span class="red-text">*</span></label>
                      <input  placeholder="Please enter number of portfolio" type="text"  id="portfoilo" ng-model="portfolio" ng-value="testimonial"  class="form-control title required"  >
