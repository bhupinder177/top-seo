                          ...
                          <div class="col-md-12">
                              ...
                              <a hand id="plusicon">Premium Plan task <i ng-click="premiumadd(key)" class="fa fa-fw fa-plus-square"></i></a>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>Price</label>
                                       <input numbers-only="numbers-only" placeholder="Please enter price" numbers-only="numbers-only" type="text" ng-model="premiumprice" ng-value="premiumprice"  class="form-control">
