...
<!-- <script src="<?php echo base_url(); ?>assets/dashboard/js/mobiscroll.angularjs.min.js"></script> -->
...
<script>
  ...
  $('body').on('click', '.buy_now', function(e){
    ...
    "handler": function (response){
          $.ajax({
            url: SITEURL + 'freelancer/membershipUpgradePayment',
            type: 'post',
            dataType: 'json',
            data: {
                razorpay_payment_id: response.razorpay_payment_id , totalAmount : totalAmount ,employee:employee,project:project,expense:expense,invoice:invoice,package:packages,testimonial:testimonial,portfolio:portfolio,casestudies:casestudies,services:services,industry:industry,totalamount:totalAmount
            },
            dataType    : "json",
          beforeSend  : function ()
          {
        ...
        $(".preloader").css('display','none');
            ...
            success: function (msg) {
               if(msg.success == "true")
               {
                    ...
                    $("#planUpgraded").modal('show');
                 // setTimeout(function() { location.reload(true); },1000);
               }
               else
               {
                 $.notify("Plan is Not Upgrade.", "error");
...
{
?>
<script src='<?php echo base_url(); ?>assets/calendar/main.js'></script>
<script>

  document.addEventListener('DOMContentLoaded', function() {
    var calendarEl = document.getElementById('calendar');
    var dates = new Date();
    d = new Date (dates.getFullYear(),dates.getMonth(),dates.getDate() );
 ...
 var startdate = '' + info.start.getFullYear() + '-' + (info.start.getMonth() + 1) + '-' + info.start.getDate();
 var enddate = '' + info.end.getFullYear() + '-' + (info.end.getMonth() + 1) + '-' + info.end.getDate();
        $.ajax({
       type :'POST',
       url: '<?php echo base_url(); ?>freelancer/getattendancedata',
       data: {
...
<script>
(function () {
$('.box.box-success>.table-responsive').on('shown.bs.dropdown', function (e) {
var $table = $(this),
...
$('.box.box-success>.table-responsive').on('hide.bs.dropdown', function () {
...
$(".startdate").datepicker({
      ...
      $(".cstartdate").datepicker({
                ...
                onSelect: function (date) {
                    ...
                    var date2 = $('.cstartdate').datepicker('getDate');
                    date2.setDate(date2.getDate());
                    $('.cenddate').datepicker('setDate', date2);
                    $('.cenddate').datepicker('option', 'minDate', date2);
                }
            });
            $('.enddate').datepicker({
                dateFormat: "dd-mm-yy",
                minDate: 1,
                onClose: function () {
                    var dt1 = $('.cstartdate').datepicker('getDate');

                    var dt2 = $('.cenddate').datepicker('getDate');
                    if (dt2 <= dt1) {
                        var minDate = $('.cendate').datepicker('option', 'minDate');
                        $('.cenddate').datepicker('setDate', minDate);
                    }
                }
            });
      // contact assign date
      ...
      $(".taskstartdate").datepicker({
          ...
          onSelect: function (date) {
              ...
              angular.element(document.getElementById('tasksection')).scope().datedata(date2,date2);
      ...
      // task edit
      $(".taskstartdate1").datepicker({
          dateFormat: "dd-mm-yy",
          minDate: 0,
          onSelect: function (date) {
              var date2 = $('.taskstartdate1').datepicker('getDate');
              date2.setDate(date2.getDate());
              // console.log(date2);
              $('.taskenddate1').datepicker('setDate', date2);
              $('.taskenddate1').datepicker('option', 'minDate', date2);

          }
      });
      $('.taskenddate1').datepicker({
          dateFormat: "dd-mm-yy",
          minDate: 0,
          onClose: function () {
              var dt1 = $('.taskstartdate1').datepicker('getDate');

              var dt2 = $('.taskenddate1').datepicker('getDate');
              if (dt2 < dt1) {
                  var minDate = $('.taskendate1').datepicker('option', 'minDate');
                  $('.taskenddate1').datepicker('setDate', minDate);
              }
          }
      });
      // task edit
      // task reassign
      $(".taskstartdate3").datepicker({
          dateFormat: "dd-mm-yy",
          minDate: 0,
          onSelect: function (date) {
              var date2 = $('.taskstartdate3').datepicker('getDate');
              date2.setDate(date2.getDate());

              $('.taskenddate3').datepicker('setDate', date2);
              $('.taskenddate3').datepicker('option', 'minDate', date2);

          }
      });
      $('.taskenddate3').datepicker({
          dateFormat: "dd-mm-yy",
          minDate: 0,
          onClose: function () {
              var dt1 = $('.taskstartdate3').datepicker('getDate');

              var dt2 = $('.taskenddate3').datepicker('getDate');
              if (dt2 < dt1) {
                  var minDate = $('.taskendate3').datepicker('option', 'minDate');
                  $('.taskenddate3').datepicker('setDate', minDate);
              }
          }
      });
      // task reassign
...
$(".expensedate").datepicker({
        ...
        $(".interviewsearchdate").datepicker({
                  dateFormat: "dd-mm-yy",
      ...
      $(".invoicestartdate").datepicker({
          dateFormat: "dd-mm-yy",
          onSelect: function (date) {
              var date2 = $('.invoicestartdate').datepicker('getDate');
              date2.setDate(date2.getDate());
              $('.invoiceenddate').datepicker('setDate', date2);
              $('.invoiceenddate').datepicker('option', 'minDate', date2);
          }
      });
      ...
      $('.invoiceenddate').datepicker({
          dateFormat: "dd-mm-yy",
          onClose: function () {
              var dt1 = $('.invoicestartdate').datepicker('getDate');
               if(dt1)
               {
              var dt2 = $('.invoiceenddate').datepicker('getDate');
              if (dt2 <=  dt1)
              {
                  var minDate = $('.invoiceenddate').datepicker('option', 'minDate');
                  $('.invoiceenddate').datepicker('setDate', minDate);
              }
             }
          }
      });
      ...
      $('#incomeenddate').datepicker({
        ...
        $(".startdate1").datepicker({
              ...
              $(".taskassignstartdate").datepicker({

                        dateFormat: "dd-mm-yy",
                        onSelect: function (date) {

                            var date2 = $('.taskassignstartdate').datepicker('getDate');
                            date2.setDate(date2.getDate());
                            // $('.taskassignenddate').datepicker('setDate', date2);
                            $('.taskassignenddate').datepicker('option', 'minDate', date2);
                        }
                    });
                    $('.taskassignenddate').datepicker({
                        dateFormat: "dd-mm-yy",
                        onClose: function () {
                            var dt1 = $('.taskassignstartdate').datepicker('getDate');

                            var dt2 = $('.taskassignenddate').datepicker('getDate');

                            if (dt2 <= dt1) {
                                var minDate = $('.taskassignenddate').datepicker('option', 'minDate');
                                $('.taskassignenddate').datepicker('setDate', minDate);
                            }
                        }
                    });

                    // dsr
                    $("#dsrstartdate").datepicker({

                              dateFormat: "dd-mm-yy",
                              onSelect: function (date) {

                                  var date2 = $('#dsrstartdate').datepicker('getDate');
                                  date2.setDate(date2.getDate());
                                  // $('#dsrenddate').datepicker('setDate', date2);
                                  $('#dsrenddate').datepicker('option', 'minDate', date2);
                              }
                          });
                          $('#dsrenddate').datepicker({
                              dateFormat: "dd-mm-yy",
                              onClose: function () {
                                  var dt1 = $('#dsrstartdate').datepicker('getDate');

                                  var dt2 = $('#dsrenddate').datepicker('getDate');

                                  if (dt2 <= dt1) {
                                      var minDate = $('#dsrenddate').datepicker('option', 'minDate');
                                      $('#dsrenddate').datepicker('setDate', minDate);
                                  }
                              }
                          });
                    // dsr
                    ...
                    // employee dsr
                    $(".emdsrstartdate").datepicker({
                        dateFormat: "dd-mm-yy",
                        maxDate: 0,
                        onSelect: function (date) {
                            var date2 = $('.emdsrstartdate').datepicker('getDate');
                            date2.setDate(date2.getDate());

                            // $('.emdsrenddate').datepicker('setDate', date2);
                            $('.emdsrenddate').datepicker('option', 'minDate', date2);

                        }
                    });
                    $('.emdsrenddate').datepicker({
                        dateFormat: "dd-mm-yy",
                        maxDate: 0,
                        onClose: function () {
                            var dt1 = $('.emdsrstartdate').datepicker('getDate');

                            var dt2 = $('.emdsrenddate').datepicker('getDate');
                            if (dt2 < dt1) {
                                var minDate = $('.emdsrenddate').datepicker('option', 'minDate');
                                $('.emdsrenddate').datepicker('setDate', minDate);
                            }
                        }
                    });

                    $(".emdsrstartdate1").datepicker({
                        dateFormat: "dd-mm-yy",
                        onSelect: function (date) {
                            var date2 = $('.emdsrstartdate1').datepicker('getDate');
                            date2.setDate(date2.getDate());

                            $('.emdsrenddate1').datepicker('setDate', date2);
                            $('.emdsrenddate1').datepicker('option', 'minDate', date2);

                        }
                    });
                    $('.emdsrenddate1').datepicker({
                        dateFormat: "dd-mm-yy",
                        onClose: function () {
                            var dt1 = $('.emdsrstartdate1').datepicker('getDate');

                            var dt2 = $('.emdsrenddate1').datepicker('getDate');
                            if (dt2 < dt1) {
                                var minDate = $('.emdsrenddate1').datepicker('option', 'minDate');
                                $('.emdsrenddate1').datepicker('setDate', minDate);
                            }
                        }
                    });
                    // employee dsr
    ...
    $(".dsrdate").datepicker({
              ...
              maxDate: 0,
              onSelect: function (date) {
                angular.element(document.getElementById('employeedsr')).scope().getdatewisedsr();
...
$(".leavestartdate").datepicker({
          ...
          onSelect: function (date) {
            // console.log("sss");
              var date2 = $('.leavestartdate').datepicker('getDate');
              date2.setDate(date2.getDate());
              $('.leaveenddate').datepicker('setDate', date2);
              $('.leaveenddate').datepicker('option', 'minDate', date2);
          }
      });
      $('.leaveenddate').datepicker({
          ...
          minDate: 0,
          onClose: function () {
              var dt1 = $('.leavestartdate').datepicker('getDate');

              var dt2 = $('.leaveenddate').datepicker('getDate');
              if (dt2 <= dt1) {
                  var minDate = $('.endate').datepicker('option', 'minDate');
                  $('.leaveenddate').datepicker('setDate', minDate);
              }
          }
      });
// employeeleave
...
$(".dashboardstartdate").datepicker({
          ...
          onSelect: function (date) {
            // console.log("sss");
              var date2 = $('.dashboardstartdate').datepicker('getDate');
              date2.setDate(date2.getDate());
               $('.dashboardenddate').datepicker('setDate', date2);
              $('.dashboardenddate').datepicker('option', 'minDate', date2);
          }
      });
      $('.dashboardenddate').datepicker({
          dateFormat: "dd-mm-yy",
          onClose: function () {
              var dt1 = $('.dashboardstartdate').datepicker('getDate');

              var dt2 = $('.dashboardenddate').datepicker('getDate');
              if (dt2 <= dt1)
              {
                  var minDate = $('.dashboardenddate').datepicker('option', 'minDate');
                  $('.dashboardenddate').datepicker('setDate', dt1);
              }
          }
      });
...
{
  angular.element(document.getElementById('servicecontroller')).scope().cleardata();
...
var idd = $($(e.target).parent()).attr('id');
if((!idd && e.target.id != 'portfolioskill') || (idd && idd != 'chosenresults11'))
{
 angular.element(document.getElementById('salesportfolio')).scope().cleardata();
}
});
<?php } ?>
...
item =  item.replace(",", " ");
 ...
 return  item.split(' ').map(name => name[0]).join('').toUpperCase();
};
...
$scope.plan = [];
$scope.skip = 1;
$scope.addgroupmemberId = '';
$scope.changegroupdata = [];
$scope.groupkey = '';
$scope.selectedgroupName ='';
$scope.addgroupmemberAdminId = '';
...
if(data)
{
  $scope.selectmember.push(data);
}
for(var c in $scope.person)
{
  if($scope.person[c].u_id == data.UserId )
  {
  $scope.person[c].select = 1;
  }
}
$scope.$apply();
});
...
{
   var obj ={};
   obj['u_id'] = $scope.selectmember[data.Key].UserId;
   obj['name'] = $scope.selectmember[data.Key].MemberName;
   obj['select'] = 0;
   $scope.selectmember.splice(data.Key,'1');
    for(var c in $scope.person)
    {
      if($scope.person[c].u_id == data.UserId)
     {
...
$scope.getallLatestgroup(msg['MSG_ROOMID']);
...
//console.log(data);
$scope.groupname = '';
angular.element('#groupcreate').modal('hide');
 $.notify("Chat Created Successfully", "success");
$scope.group.unshift(data);
$scope.groupkey = 0;
$scope.selectedgroupName = $scope.group[0].Name;
$scope.roomId = $scope.group[0]._id;
$scope.socketjoingroup($scope.roomId);
$scope.getchat($scope.roomId);
socket.emit('addmember', { GroupId:data._id,'MemberName':$scope.username,UserId:'<?php echo $this->session->userdata['clientloggedin']['id']; ?>'});
$scope.$apply();
...
{
$scope.group[data.key].Name = data.Name;
angular.element('#groupedit').modal('hide');
 $.notify("Chat Updated Successfully", "success");
$scope.$apply();
});

socket.on('deletegroup', function(data)
{
 $scope.group.splice(data.key,'1');
...
socket.emit('creategroup', { Name:$scope.groupname,UserId:'<?php echo $this->session->userdata['clientloggedin']['id']; ?>',Type:0});

$scope.gSubmit = false;
}

$scope.groupEdit = function(key,id)
{
  $scope.groupname1 = $scope.group[key].Name;
  $scope.groupId = id;
  $scope.groupkey = key;
  angular.element('#groupedit').modal();
}
...
socket.emit('Updategroup', { key:$scope.groupkey, Name:$scope.groupname1,id:$scope.groupId});

$scope.gSubmit = false;
}

$scope.groupconfirm = function(key,id)
{
  $scope.groupId = id;
  $scope.groupkey = key;
...
{
 socket.emit('deletegroup', { key:$scope.groupkey,id:$scope.groupId});
}


$scope.addmembers = function(id,adminId)
{
  $scope.selectmember = [];
  $scope.addgroupmemberId = id;
  $scope.addgroupmemberAdminId = adminId;


  $http({
    url: 'https://top-seo-sockets.herokuapp.com/get-group-members?groupId='+id,
    method: "GET",
    headers: {
    ...
    {
     $scope.selectmember = response.data.members;

       for(var c in $scope.person)
       {
         $scope.person[c].select = 0;

         for(var a in $scope.selectmember)
         {

          if($scope.person[c].u_id == $scope.selectmember[a].UserId)
          {
            $scope.person[c].select = 1;
          }
        }
  ...
  angular.element('#addmember').modal('show');
...
$scope.selectgroup = function(id,key)
{
$scope.roomId = id;
$scope.groupkey = key;
$scope.selectedgroupName = $scope.group[key].Name;
$scope.socketjoingroup($scope.roomId);
$scope.getchat($scope.roomId);
}
...
{
$http({
  url: '<?php echo base_url(); ?>freelancer/getgroupSuggestionPerson',
  method: "POST",
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  }
...
$scope.getallLatestgroup = function (id)
{
  for(var a in $scope.group)
  {
    if($scope.group[a]._id == id)
    {
      dd = $scope.group[a];
      $scope.group.splice(a,'1');
    }
  }

  // var dd = $scope.group[$scope.groupkey];
  $scope.group.unshift(dd);
  // $scope.groupkey = '';
}
...
{
var obj = { };
obj['UserId'] =    $scope.person[key].u_id;
obj['MemberName'] = $scope.person[key].name;
obj['GroupId'] =   $scope.addgroupmemberId;
...
{
var userId = $scope.selectmember[key].UserId;
var obj = {};
obj['UserId'] = userId;
obj['Key'] = key;
...
for(var c in $scope.selectmember)
{
  ...
  a['MemberName'] = $scope.selectmember[c].name;
  $scope.data.push(a);
}
...
//job status
$scope.offerStatus = function($offerid,$jobId,$user,$from,$status,$offamount,$proposal)
{
if($status == '1')
{
  if($offamount != $proposal)
  {
    $.notify("Please Adjust Milestone Total Price According to Offer Received", "error");
...
$http({
  ...
  if(response.data.message == "true")
  {
    if(status == 1)
    {
    $.notify("Job Offer Accepted  Successfully", "success");
    }
    else if(status == 2)
    {
      $.notify("Job Offer Rejected Successfully", "success");
    }
  }
...
var app5 = angular.module('myApp5',['luegg.directives'])
...
app5.directive('ngEnter', function () {
return function (scope, element, attrs) {
    element.bind("keydown keypress", function (event) {
        if (event.which === 13) {
            scope.$apply(function () {
...
$scope.usersId = response.data.userid;
   ...
   if(text != '')
   {
     ...
     $http({
       ...
       if(response.data.message == "true")
       {
         ...
         $scope.getlog($scope.job.proposalId);
       }
     });
   }
 }
          ...
          $scope.submitMilestone = function()
					{
					 ...
					 if(error == true)
						...
						var m = JSON.stringify({ proposalId:$scope.job.proposalId, milestone:$scope.milestones,newProposedOffer:$scope.newoffer});
						angular.element(".preloader").show();
						 $http({
						 url: '<?php echo base_url(); ?>freelancer/updatemilestone',
						 method: "POST",
						 data: m,
						 headers: {
							'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
	     ...
	     $scope.totalmilestone = function($event)
					{
					     ...
					     for(var i in $scope.milestones )
					    {
					      ...
					      $scope.newoffer = +$scope.newoffer + +$scope.milestones[i]['price'];
					    }
					  }
...
//job status
$scope.offerStatus1 = function($offerid,$jobId,$user,$from,$status,$offamount,$proposal,$newproposal)
{
  if($status == '1')
  {
    if($offamount != $proposal && $newproposal == 0)
    {
      $.notify("Please Adjust Milestone Total Price According to Offer Received", "error");
    }
    else if($offamount != $newproposal && $newproposal != 0 )
    {
      $.notify("Please Adjust Milestone Total Price According to Offer Received", "error");
    }
    else
    {
     angular.element(".jtitle").html("Accept Job Offer");
     angular.element("#accept").modal('show');
    }
 }
else if($status == '2')
{
  angular.element(".jtitle").html("Reject Job Offer");
  angular.element("#accept").modal('show');
}
angular.element(".offerId").val($offerid);
angular.element(".jobId").val($jobId);
...
var user	= angular.element(".userId").val();
var from =	angular.element(".from").val();
$scope.message2 =	angular.element(".message2").val();
var status = angular.element(".status").val();
if($scope.message2 == '' || offerid == ''  || user == '' || from == '' || jobId == '')
{
  error = true;
}
...
var obj = {  offertotal:$scope.job.offAmount,offerId : offerid,user:user,from:from,message:$scope.message,jobId:jobId,status:status }
angular.element(".preloader").show();
$http({
  url: '<?php echo base_url(); ?>freelancer/jobMesaage',
  method: "POST",
...
//job message
 ...
 $scope.milestoneshow = function ()
 {
   $scope.milestones = $scope.job.milestone;
...
$scope.assigntaskprojectmanager = function ($event)
{
  var user = angular.element($event).val();
  var a = angular.element($event);
  var b = a[0].selectedOptions[0];
  var c =b.getAttribute('data-id');

  var obj = {  id : c,assignedBy:user };
  if(user != '')
  {
  $http({
...
$scope.changeclientStatus = function($event)
{
  ...
  {
    $http({
     url: '<?php echo base_url(); ?>freelancer/contractStatus',
     method: "POST",
     data:obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
...
$scope.clicknotification = function(id)
{
  alert(id);
}
...
// {
//
//   $scope.userid = response.data.result;
//   $scope.notification($scope.notify[0]['notificationId'],$scope.userid);
// });
// },10000);
...
$scope.companylogoerror = false;
$scope.companylogoerror11 = false;
$scope.profileimageerror = false;
$scope.profileimageerror11 = false;
$scope.phonetime = 0;

$scope.removebrakcet = function ()
{
...
// $scope.profile.city == ''
if($scope.profile.name == '' || $scope.profile.phone == '' || $scope.profile.zip == '' || $scope.profile.country == '' || $scope.profile.state == ''  || $scope.profile.desig == '' || $scope.profile.year == '')
{
  error = true;
}

// $scope.profile.address2 == '' ||
if($scope.profile.address1 == '' ||  $scope.profile.about == '' || $scope.profile.minPrice == '' || $scope.profile.maxPrice == '' || $scope.profile.c_name =='' || $scope.profile.logo == '' ||  $scope.profile.currencyId == '' || $scope.profile.maxPrice == 0 )
{
  error = true;
}
...
if($scope.profile.type == 2)
{
  ...
  if(parseInt($scope.profile.minPrice) == 0 || parseInt($scope.profile.maxPrice) == 0)
  {
    error = true;
  }
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $interval(callAtInterval, 2000);
       function callAtInterval()
       {
        $window.location.href = '<?php echo base_url(); ?>cprofile/<?php echo $this->session->userdata['clientloggedin']['url']; ?>';
         ...
         // {
         //   $window.location.href = '<?php echo base_url(); ?>services/<?php //echo $this->session->userdata['clientloggedin']['url']; ?>';
         // }
       }
  }
...
{
   $scope.companylogoerror = true;
   $scope.companylogoerror11 = true;
...
if ($.inArray(type[1], ['gif','png','jpg','jpeg']) == -1)
{
 $scope.profileimageerror = true;
 $scope.profileimageerror11 = true;
}
else
{
  $scope.profileimageerror = false;
...
$scope.profile = [];
$scope.department = [];
$scope.industrynorecord = false;
$scope.servicesnorecord = false;
$scope.submitr = false;
$scope.req = false;
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $.notify("Services Added Successfully", "success");
  }
});
}
...
if($scope.selectedIndustry.length >= $scope.plan.industry )
{
  match = true;
}
...
if($scope.selectedService.length >= $scope.plan.services )
{
  match = true;
}
...
app11.controller('myCtrt11', function($interval,$scope,$window,$http) {
$scope.logo ='';
$scope.title ='';
$scope.youtube_url='';
$scope.testimonial ='';
...
$scope.total = 0;
$scope.companylogoerror = false;
$scope.websiterror = false;
$scope.youtubeerror = false;


$scope.websitecheck = function($event)
{
     var website = $event.value;
    if(!website.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
    {
      error = true;
      $scope.websiterror = true;
    }
    else
    {
      $scope.websiterror = false;
...
$scope.youtubecheck = function($event)
{
     var youtube = $event.value;
    if(!youtube.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
    {
      error = true;
...
$scope.addtestimonial = function()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.testimonial != $scope.total && $scope.plan.testimonial >= $scope.total)
    {
       $window.location.href ="<?php echo base_url(); ?>freelancer/testimonial/add";
    }
    else
    {
      $("#packageUpgrade").modal('show');
    }
  });
...
$scope.clickUpgrade = function()
{
  ...
  window.open('<?php echo base_url(); ?>membership/<?php echo $this->session->userdata['clientloggedin']['url']; ?>', '_blank');
...
if($scope.youtube_url != '')
{
if(!$scope.youtube_url.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
{
  error = true;
  $scope.youtubeerror = true;
}
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    angular.element('.testimonialview').hide();
    angular.element('.testimonialimg').val('');
    $scope.logo='';
    $.notify("Testimonial Added Successfully", "success");
    $interval(callAtInterval, 2500);
     function callAtInterval()
     {
      $window.location.href = '<?php echo base_url(); ?>testimonial/<?php echo $this->session->userdata['clientloggedin']['url']; ?>';
     }
   }
});
   }
...
$scope.download = function (name,file)
{
...
$scope.savecasestudy = function ()
{
  $http({
    ...
    if($scope.plan.casestudies != $scope.total && $scope.plan.casestudies >= $scope.total)
   {
...
app13.controller('myCtrt13', function($scope,$window,$http,$interval) {
$scope.pricings = [];
$scope.services = [];
$scope.ser ='';
$scope.price = '';
...
$scope.savepricing = function ()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.package != $scope.total && $scope.plan.package >= $scope.total)
    {
...
$scope.price1 = angular.element('#price5').val();
$scope.currencyId1 = angular.element("#currencyId1").val();
$scope.ser1 = angular.element("#service1").val();
...
$scope.clickaddEmployee = function()
{
  $http({
    url: '<?php echo base_url(); ?>freelancer/selectedplan',
    method: "POST",
    ...
    $scope.plan = response.data.result;
    if($scope.plan.employee != $scope.total && $scope.plan.employee >= $scope.total)
    {
       $window.location.href ="<?php echo base_url(); ?>team-add/<?php echo $this->session->userdata['clientloggedin']['url']; ?>";
    }
    else
    {
      $("#packageUpgrade").modal('show');
...
$scope.perhour = parseInt($scope.perday / totalhours) ;
;
...
$scope.perhour = parseInt($scope.perday1 / $scope.working.workingHour) ;
}
...
angular.element(".preloader").show();
// ,status : $scope.status
var obj = {  name  : $scope.name , desig  : $scope.designation,logo: $scope.image , perHour : $scope.perhour ,rep_ph_num : $scope.phone, address1  : $scope.address,services : $scope.skill, access :$scope.access ,email : $scope.email,project :$scope.project,salary:$scope.salary,perday:$scope.perday,skype:$scope.skype,countryCode:$scope.countrycode,countryClass:cl,salaryCurrencyId:$scope.currency,department:$scope.department,joiningdate:$scope.joiningdate };
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $scope.perhour1 = $scope.editTeam.perHour;
    $scope.hourlyprice = $scope.editTeam.maxPrice;
    ...
    $scope.salarycurrencyId = $scope.editTeam.salaryCurrencyId;
    console.log($scope.salarycurrencyId);
    $scope.department1 = $scope.editTeam.department;
    $scope.joiningdate1 = $scope.editTeam.joiningdate;
    CKEDITOR.instances['about'].setData($scope.editTeam.about);
...
$scope.about1 = CKEDITOR.instances['about'].getData();
...
if($scope.phone1 == '' || $scope.address1 == '' || $scope.skype1 == '' || $scope.salary1 == '' || $scope.perday1 == '' || $scope.currency1 == '' || $scope.salarycurrencyId == ''  || $scope.hourlyprice == '' || $scope.department1 =='' || $scope.joiningdate1 == '' || $scope.about1 == '')
{
  error = true;
}
...
angular.element(".preloader").show();
var obj = {  name  : $scope.name1 , desig  : $scope.designation1,logo : $scope.image , maxPrice : $scope.hourlyprice ,services : $scope.skill1, access :$scope.access1,id:$scope.editTeam.u_id,status:$scope.status1,salary:$scope.salary1,about:$scope.about1,perHour:$scope.perhour1,perday:$scope.perday1,skype:$scope.skype1,address1:$scope.address1,department:$scope.department1 ,currencyId:$scope.currency1,salarycurrencyId:$scope.salarycurrencyId,experience:$scope.experience,joiningdate:$scope.joiningdate1};
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $.notify("Employee Info Updated Successfully", "success");
    $scope.team();
  }
...
$scope.changezone = function($event)
{
  var a = angular.element($event);
  $scope.countryzone = a;
  var b = a[0].selectedOptions[0];
  $scope.zone = b.getAttribute('data-id');
}
...
$scope.paypalcheck = function($event)
{
  var email = $event.value;
  var regex = /^\S+@\S+\.\S+$/;
  if(regex.test(email) === false)
 {
   $scope.paypalerror = true;
 }
 else
 {
   $scope.paypalerror = false;
...
$http({
  ...
  if(response.data.success == "true")
  {
    ...
    $scope.countryzone = response.data.result.countryzone;
  }
...
{
  var regex = /^\S+@\S+\.\S+$/;
  if(regex.test($scope.paypal) === false)
 {
   error = true;
   $scope.paypalerror = true;
 }
...
var obj = {  bankdetail  : $scope.account,paypal:$scope.paypal,currencyId:$scope.currency,zone:$scope.zone,countryzone:$scope.countryzone   };
...
$http({
  ...
  if(response.data.success == "true")
  {
    $.notify("Basic Information Updated Successfully ", "success");
...
$http({
  ...
  if(response.data.message == "true")
  {
    $.notify("Service Description Added Successfully", "success");
...
$scope.convertlead = function (key,id)
{
  $scope.key = key;
  $scope.id = id;
  angular.element('#confirm').modal('show');
...
$scope.convert = function()
{
  var obj = {  id : $scope.id }
  $http({
    url: '<?php echo base_url(); ?>freelancer/convertlead',
    method: "POST",
    data:obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  ...
  {
    angular.element('#confirm').modal('hide');
    $.notify("Request Converted To Lead Successfully", "success");
    $scope.request.splice($scope.key,1);
  }
  });
}
 ...
 $scope.viewRequest = function(id)
 {
   var obj = {  id : id }
   $http({
     url: '<?php echo base_url(); ?>freelancer/viewRequest',
     method: "POST",
     data:obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   ...
   if(response.data.success ="true")
   {
     ...
     angular.element('#viewrequest').modal('show');
...
return {
  ...
  link: function (scope, element, attrs, ngModelCtrl) {
    element.datepicker({
      ...
      onSelect: function (date) {
        scope.date = date;
        scope.profile.dateofbirth = date;
...
$scope.activityAdd = function ($event)
{
...
{
   var checked = false;
  for(var r in $scope.experience)
  {
    if($scope.experience[r].working == 1)
    {
       checked = true;
    }
  }
...
$scope.selectworking = function ($event,key)
{
  if($event.target.checked ==  true)
  {
    for(var r in $scope.experience)
    {
      $scope.experience[r].selectedworking = 1;
    }
    $scope.experience[key].selectedworking = 0;
    $scope.experience[key].MonthEnd = '';
    $scope.experience[key].YearEnd = '';
    $scope.selectedworking = 1;
  }
  else
  {
    for(var r in $scope.experience)
    {
      $scope.experience[r].selectedworking = 0;
    }
  }
...
$scope.deleteactivities = function ($key)
{
$scope.activities.splice($key,1);
}
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    if($scope.profile.maritalStatus == 0)
    {
      $scope.profile.maritalStatus = '';
    }
    ...
    if($scope.profile['experience'].length != 0)
    {
      ...
      if($scope.profile['experience'][r]['experienceYearEnd'] == 0)
      {
        ex['YearEnd'] = '';
      }
      else
      ...
      if($scope.profile['experience'][r]['experienceCurrentlyWorking'] == 1)
      {
      ex['working'] = true;
      }
      else
      ...
      $scope.experience.push(ex);
        ...
        for(var r in $scope.experience)
        {
          if(checked)
          {
          if($scope.experience[r].working == "true")
          {
           $scope.experience[r].selectedworking = 0;
          }
           else
    ...
    if($scope.profile['activities'].length != 0)
    {
      $scope.activities = [];
     for(var r in $scope.profile['activities'])
     {
      var ac = {};
      ac['name'] = $scope.profile['activities'][r]['name'];
      ac['upload'] = $scope.profile['activities'][r]['upload'];
      ac['type'] = $scope.profile['activities'][r]['type'];
      ac['error'] = 0;

      $scope.activities.push(ac);
      }
...
if($scope.profile.name =='' || $scope.profile.desig == "" || $scope.profile.rep_ph_num == '' || $scope.profile.address == "" || $scope.profile.about == '' || $scope.services.lenth == 0 || $scope.profile.dateofbirth == '' ||  !$scope.profile.maritalStatus || $scope.profile.logo == '' || $scope.profile.address1 == '' )
{
  error = true;
}
...
for(var a in $scope.experience)
{
  if($scope.experience[a].YearEnd == 0)
  {
    $scope.experience[a].YearEnd = '';
  }
  if($scope.experience[a].designation == '' || $scope.experience[a].MonthStart == '' || $scope.experience[a].YearStart == '' || $scope.experience[a].description == '' || $scope.experience[a].company == '')
  {
    error = true;
...
if($scope.activities)
{
  ...
  {
    if($scope.activities[a].type == '' || $scope.activities[a].name == '' || $scope.activities[a].upload == '')
    {
      error = true;
    }
  }
...
$scope.uploadcertificate = function ($event) {
  var key = angular.element($event).attr('data-id');
var files =$event.files;
var type = files[0].type.split("/");

if ($.inArray(type[1], ['gif','png','jpg','jpeg']) == -1)
{
  $scope.activities[key].error = 1;

}
else
{
  $scope.activities[key].error = 0;
 for (var i = 0; i < files.length; i++) {
  var f = files[i]
  var fileName = files[i].name;
  var filePath = fileName;
  ...
  fileReader.onload = (function(e) {
    ...
    $http({
      ...
      $scope.activities[key].upload = response.data;
...
$scope.portfolioopn = function ()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.portfolio != $scope.total && $scope.plan.portfolio >= $scope.total)
    {
      $scope.services =[];
      $scope.title ='';
      $scope.description ='';
      ...
      angular.element('#portfolio').modal('show');
    }
    else
    {
      $("#packageUpgrade").modal('show');
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $scope.image = $scope.editportfolio.portfolioImage;
...
var error = false;
$scope.title = angular.element('#title').val();
$scope.website = angular.element('#website1').val();
...
$scope.addexpense = function()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.expense != $scope.total && $scope.plan.expense >= $scope.total)
    {
...
$scope.breakfasrerror = 0;
$scope.teaerror = 0;
$scope.luncherror = 0;
$scope.dinnererror = 0;
$scope.workinghourserror = 0;
...
$scope.changesalaryoption = function($event)
{
   var key = $event.target.id;
  if($event.target.checked)
  {
  //  $scope.breaks[key].includeSalary = 1;
  }
  else
  {
   $scope.breaks[key].includeSalary = 0;
   //console.log("sss");
  }
}
...
$scope.addholiday = function()
{
  ...
  $scope.saveworking = function()
  {
    ...
    if($scope.workinghours   == '' || $scope.workingdays  == '' || $scope.total  == ''  )
    {
     ...
     {
     var isValid3 = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.workinghours);
  ...
  $scope.saveBreak1 = function()
  {
    $scope.submitb =  true;
    if($scope.breakfasthr != '')
    {
     var isValid = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.breakfasthr);
     if (isValid)
     {
      $scope.breakfasrerror = 0;
     }
    ...
    if($scope.lunchhr != '')
    {
     var isValid1 = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.lunchhr);
    ...
    if($scope.teahr != '')
    {
     var isValid2 = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.teahr);
    ...
    if($scope.dinnerhr != '')
    {
     var isValid3 = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.dinnerhr);
      ...
      if($scope.breakfasthr == '' && $scope.lunchhr == '' && $scope.teahr == ''  && $scope.dinnerhr == ''  )
      {
       return false;
      }
    ...
    var obj = {  breakfasthr :$scope.breakfasthr,lunchhr:$scope.lunchhr,teahr :$scope.teahr,dinnerhr :$scope.dinnerhr };
//  var obj = {  breakfasthr :$scope.breakfasthr,breakfastmin:$scope.breakfastmin, lunchhr:$scope.lunchhr,lunchmin:$scope.lunchmin,teahr :$scope.teahr,teamin:$scope.teamin,dinnerhr :$scope.dinnerhr,dinnermin:$scope.dinnermin };
  ...
  $scope.saveBreak = function()
  {
    ...
    if($scope.breaks)
    {
      for(var a in $scope.breaks)
      {
        if($scope.breaks[a].name == '')
        {
          error = true;
        }
        if($scope.breaks[a].hh == '' && $scope.breaks[a].mm == '')
        {
          error = true;
        }
      }
    ...
    $http({
      ...
      {
        $.notify("Break Time not Added", "error");
      }
  ...
  $scope.getbreak = function()
  {
    $http({
      ...
      if(response.data.message == "true")
      {
        $scope.breaks = response.data.result;
      }
    });
  }
  ...
  $scope.totalHours = function()
  {
    ...
    var isValid3 = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.workinghours);
     ...
     {
       var minutes = 0;
       var a = $scope.workinghours.split(":");
       var hours = a[0] * 60;
       if(a[1])
       {
        minutes = a[1];
       ...
       //var h = parseFloat(total / 60);

       var total = total * $scope.workingdays;

       var h = parseInt(total / 60);
       if(h < 10)
       {
         h = '0'+h;
       }
  ...
  $scope.saveResignation = function()
  {
    ...
    $http({
      ...
      if(response.data.message == "true")
      {
        $.notify("Notice Period Added Successfully", "success");
  ...
  $scope.checkhours = function ($event)
  {
    if($scope.breaks.length != 0)
    {
      for(var a in $scope.breaks)
      {
        if($scope.breaks[a].hh > 12)
        {
          $scope.breaks[a].hh = 12;
        }
      }
    }
  }

  $scope.checkminut = function ($event)
  {
    if($scope.breaks.length != 0)
    {
      for(var a in $scope.breaks)
      {
        if($scope.breaks[a].mm > 59)
        {
          $scope.breaks[a].mm = 59;
        }
      }
    }
  }

  $scope.deletebreak = function(key)
  {
    $scope.breaks.splice(key,'1');
  }

  $scope.checkbreakhrs = function ()
  {
    if($scope.breakfasthr > 12)
    {
      $scope.breakfasthr = 12;
    }
  }
  ...
  $scope.checkdinnerhrs = function()
  {
    if($scope.dinnerhr >12)
    {
      $scope.dinnerhr = 12;
    }
  }
...
app26.controller('myCtrt26', function($scope,$window,$http,$interval) {
  ...
  $scope.removedocument = function(k)
  {
    $scope.document.splice(k,1);
  }
...
$scope.addproject = function()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.project != $scope.total && $scope.plan.project >= $scope.total)
    {
       $window.location.href ="<?php echo base_url(); ?>freelancer/project_add";
    }
    else
    {
      $("#packageUpgrade").modal('show');
...
$scope.clickUpgrade = function()
{
  ...
  $scope.counttotalhour = function($event)
  {
    ...
    for(var i in $scope.milestones )
    {
      ...
      $scope.totalhour += +$scope.milestones[i]['hours'];
      $scope.budget = $scope.totalhour * $scope.hourlyprice;
    }
     if($scope.upfront > 0)
     {
        $scope.budget = +$scope.upfront + +$scope.budget;
     }
  }
    ...
    for (var i = 0; i < files.length; i++) {
      ...
      fileReader.onload = (function(e) {
        ...
        $http({
          ...
          $scope.document.push(response.data);
  ...
  $scope.saveproject = function()
  {
    ...
    for( var res in $scope.milestones)
    {
      ...
      if($scope.milestones[res]['task'].length != 0)
      {
        for(var t in $scope.milestones[res]['task'])
        {
          if($scope.milestones[res]['task'][t]['task'] == '' || $scope.milestones[res]['task'][t]['hours'] == '' || $scope.milestones[res]['task'][t]['hours'] == 0)
          {
            error = true;
          }
        }
    ...
    if(pclass == "form-control phonenumber ng-valid ng-not-empty ng-dirty ng-valid-parse ng-touched error11")
    {
...
<?php if(isset($projectId))
{
  ...
  app28.directive('mydatepicker', function () {
    return {
      restrict: 'A',
      require: 'ngModel',
      link: function (scope, element, attrs, ngModelCtrl) {
        element.datepicker({
          ...
          onSelect: function (date) {
            scope.date = date;
            var k = angular.element(element).attr('data-key');
            var k1 = angular.element(element).attr('data-key1');
            scope.project.milestone[k].task[k1].startDate = date;
            scope.$apply();
          }
        });
      }
  ...
  app28.directive('mydatepicker1', function () {
    return {
      restrict: 'A',
      require: 'ngModel',
      link: function (scope, element, attrs, ngModelCtrl) {
        element.datepicker({
          ...
          onSelect: function (date) {
            ...
            var k = angular.element(element).attr('data-key');
            var k1 = angular.element(element).attr('data-key1');
            scope.project.milestone[k].task[k1].dueDate = date;
            scope.$apply();
          }
        });
      }
  ...
  app28.controller('myCtrt28', function($scope,$window,$http,$interval) {
    ...
    {
      $http({
        url: '<?php echo base_url(); ?>freelancer/getonlyAllEmployee',
        method: "POST",
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        }
      ...
      if($scope.project.milestone)
      {
        for(var i in $scope.project.milestone[mkey].task)
        {
          ...
          if($scope.project.milestone[mkey].task[i].checked)
          {
            ...
            obj['id'] = id;
            obj['name'] = name;
            $scope.project.milestone[mkey].task[i].assign = name;
            $scope.project.milestone[mkey].task[i].assignId = id;
    ...
    $scope.SaveMilestone = function()
    {
      ...
      if($scope.project.milestone)
      {
        for(var a in $scope.project.milestone)
        {
          ...
          {
            if($scope.project.milestone[a].task[b].checked == 1 )
            {
              if($scope.project.milestone[a].task[b].assignedTo == '')
              {
                error = true;
              }
               var id = $scope.project.milestone[a].task[b].id;
               $scope.project.milestone[a].task[b].startDate = angular.element('.startdate'+id).val();
               $scope.project.milestone[a].task[b].dueDate = angular.element('.enddate'+id).val();
               $scope.project.milestone[a].task[b].saved = 1;

               if($scope.project.milestone[a].task[b].startDate == ''  || $scope.project.milestone[a].task[b].dueDate == '')
               {
                 error = true;
               }
               ...
               if($scope.project.milestone[a].task[b].startDate  > $scope.project.milestone[a].task[b].dueDate)
               {
                 $scope.project.milestone[a].task[b].error = 1;
                 error = true;
               }
               else
               {
                 $scope.project.milestone[a].task[b].error = 0;
    ...
    $scope.AssignMilestone = function()
    {
          ...
          for(var b in $scope.project.milestone[a].task)
          {
            if($scope.project.milestone[a].task[b].checked == 1 )
            {
              if($scope.project.milestone[a].task[b].assignedTo == '')
              {
               ...
               $scope.project.milestone[a].task[b].startDate = angular.element('.startdate'+id).val();
               $scope.project.milestone[a].task[b].dueDate = angular.element('.enddate'+id).val();
               $scope.project.milestone[a].task[b].saved = 0;
      ...
      $http({
        ...
        {
          $.notify("Task Already Started", "error");
        }
      });
    }

    $scope.milestoneChecked = function($event)
    {
      if($event.target.checked ==  true)
      {
        for(var i in $scope.project.milestone)
        {

          for(var g in $scope.project.milestone[i].task)
          {
           $scope.project.milestone[i].task[g].checked = 1;
           }
         }
      }
      else
      {
        for(var i in $scope.project.milestone)
        {
          for(var g in $scope.project.milestone[i].task)
          {
           $scope.project.milestone[i].task[g].checked = 0;
           }
         }
      }
    }
      ...
      if($scope.project.milestone)
      {
        for(var a in $scope.project.milestone)
        {
           for(var b in $scope.project.milestone[a].task)
           {
             if($scope.project.milestone[a].task[b].checked == 1 )
             {
              $scope.project.milestone[a].task[b].edit = 1;
              }
            }
          }
        }
    ...
    $scope.taskkeyup = function (val,id)
    {
      var typingTimer = (new Date()).getTime()
      ...
      var timeDiff    = typingTimer - $scope.lastTypingTime;
      if (timeDiff   >= $scope.typingLENGTH && $scope.typing) {
      $scope.taskUpdate(val,id);
      $scope.typing = false;
       }
       },$scope.typingLENGTH);
    }

    $scope.taskUpdate = function (val,id)
    {
      if(val != '')
      {
        var obj = { id :id,name:val };
    ...
    $scope.addsubtask = function ()
    {
      ...
      if($scope.project.milestone)
      {
          for(var a in $scope.project.milestone)
          {
           if($scope.project.milestone[a].checked == 1 )
           {
            var  id = $scope.project.milestone[a].id;
          ...
          {
           $.notify("Please select milestone", "error");
          }
      ...
      $scope.submitsubtask = function()
      {
        ...
        if($scope.name == '' || $scope.description == ''  || $scope.hours == '' )
        {
          error = true;
        }
        if(error == true)
        ...
        var addhours = $scope.hours * $scope.ids.length;

        var obj = { projectId:'<?php echo $projectId; ?>',name:$scope.name,status:'2',description:$scope.description,hours:$scope.hours,type:2,addhours:addhours,parents:$scope.ids };
        angular.element('.preloader').show();
        $http({
          url: '<?php echo base_url(); ?>freelancer/saveSubtask',
          method: "POST",
          data: obj,
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  ...
  <?php if(isset($projectId))
  {
    ...
    app36.controller('myCtrt36', function($scope,$window,$http,$interval) {
      ...
      $scope.addSalary = function(id,date,customsalary,salary)
      {
        $scope.userId =id;
        $scope.date = date;
        if(customsalary)
        {
        $scope.netsalary = customsalary;
        }
        else
        {
          $scope.netsalary = salary;
        }
    ...
    if(!empty($taskId))
    {
      ...
      app38.controller('myCtrt38', function($scope,$window,$http,$interval) {
        ...
        $scope.resignationreason = function(id)
        {
          var obj = { id :id };
          $http({
            url: '<?php echo base_url(); ?>freelancer/getresignationreason',
            ...
            {
             $scope.leavedata = response.data.result;
              angular.element('#resignationReason').modal('show');
            }
          });
        }
    ...
    $scope.edit = function (id)
    {
      ...
      app40.controller('myCtrt40', function($scope,$window,$http,$interval) {
        ...
        $scope.submitleave = function()
        {
          ...
          var obj = { remark:$scope.remark,date:$scope.date,type:$scope.type,date1:$scope.date1,carryforwardtype:$scope.leavetype };
          angular.element('.preloader').show();
          $http({
  ...
  $scope.changePerPage = function ($event)
  {
     ...
     $scope.getleave();
        ...
        $scope.updateleave = function()
        {
          ...
          $http({
            ...
            {
              $.notify("Leave Status Already Updated", "error");
            }
            else if(response.data.notavailble == "true")
            {
              $.notify("Leave is not Available", "error");
        ...
        $scope.getcarryforward = function()
        {
          $http({
            url: '<?php echo base_url(); ?>freelancer/getemployeeCarryforward',
            method: "POST",
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
            }
            ...
            if(response.data.message == "true")
            {
              $scope.carryforward = response.data.result;
            }
          });
        }
        ...
        {
          $scope.type = $event.value;
          var a = angular.element($event);
          var b = a[0].selectedOptions[0];
          $scope.leavetype = b.getAttribute('data-id');
      ...
      app41.directive('mydatepicker', function () {
        return {
          restrict: 'A',
          require: 'ngModel',
          link: function (scope, element, attrs, ngModelCtrl) {
      ...
      app41.controller('myCtrt41', function($scope,$window,$http,$interval) {
        ...
        {
          $scope.date = angular.element('.leavedate').val();
          if($scope.date == '')
          {
            return false;
          }
        ...
        $scope.getleave = function()
        {
          var obj = { page :$scope.page,perpage:$scope.perpage,date:$scope.date };
          $http({
            ...
            if(response.data.message == "true")
            {
              ...
              if($scope.leave)
              {
                for(var a in $scope.leave)
                {
                  if($scope.leave[a].status == 2 || $scope.leave[a].status == 3)
                  {
                    $scope.leave[a].disabled = 1;
                  }
                  else
                  {
                   $scope.leave[a].disabled = 0;
                  }
                }
              }
              $scope.total = response.data.pcount;
        ...
        {
          $http({
            url: '<?php echo base_url(); ?>freelancer/allteam1',
            method: "POST",
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
            }
      ...
      app43.controller('myCtrt43', function($scope,$window,$http,$interval) {
        ...
        $scope.carryforward = [];
        $scope.ctitle ='';
        $scope.leavescarryforward = false;
        $scope.cupto ='';
        $scope.cstartdate ='';
        $scope.id = '';
        $scope.status = '';
    ...
    {
      $http({
        url: '<?php echo base_url(); ?>freelancer/getcarryforward',
        method: "POST",
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        }
    ...
    $scope.editcarryforward = function()
    {
      $scope.ctitle = $scope.carryforward.type;
      $scope.cduration = $scope.carryforward.duration;
      $scope.cdurationtype = $scope.carryforward.durationType;
      $scope.cupto = $scope.carryforward.carryUpto;
      $scope.cstartdate = $scope.carryforward.startDate;
      $scope.leavescarryforward = $scope.carryforward.leavesCarryForward;


      angular.element('#editcarryforward').modal('show');

    }

    $scope.updatecarryforward = function()
    {
      $scope.submitl = true;
      var error = false;
      $scope.cstartdate = angular.element('#cstartdate').val();

      if($scope.ctitle == ''  || $scope.cstartdate == '' || $scope.cupto == '')
      {
        error = true;
      }
      ...
      var obj = { id:$scope.carryforward.id,type:$scope.ctitle,startDate:$scope.cstartdate,carryUpto:$scope.cupto,leavesCarryForward:$scope.leavescarryforward };

      angular.element('.preloader').show();
      $http({
        url: '<?php echo base_url(); ?>freelancer/updatecarryforward',
        method: "POST",
        data: obj,
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        ...
        {
          angular.element('.preloader').hide();
          angular.element('#editcarryforward').modal('hide');
          $scope.getcarryforward();


          $.notify("Carry Forward Leave Updated Successfully", "success");
    ...
    $scope.statusconfirm = function(id,status)
    {
      $scope.id = id;
      $scope.status = status;
      angular.element('#statusconfirm').modal('show');
    }
    ...
    $scope.changeStatus = function()
    {
      ...
      $http({
        url: '<?php echo base_url(); ?>freelancer/carryforwardStatus',
        method: "POST",
        data :obj,
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        ...
        if(response.data.success == "true")
        {
           if($scope.status == 1)
           {
           $.notify("Carry Forward Leave Activated Successfully", "success");
          }
          else if($scope.status == 0)
          {
            $.notify("Carry Forward Leave Deactivated Successfully", "success");
          }
          angular.element('#statusconfirm').modal('hide');
          $scope.getcarryforward();
  ...
  app44.filter('time', function () {
    ...
    app45.filter('time', function () {
      ...
      return function (item) {
        ...
        if(minutes > 10)
        {
          var time = '' + dates.getHours() + ':' + dates.getMinutes() + ':'+seconds;
        }
        else
        {
          var time = '' + dates.getHours() + ':'+'0'+dates.getMinutes() + ':'+ seconds;
        }
  ...
  app45.controller('myCtrt45', function($scope,$window,$http,$interval) {
    ...
    $scope.disabled =0;
    $scope.check = false;
    $scope.alltasktotal = 0;
    $scope.currenttasktotal = 0;
    $scope.history = [];
    $scope.duetask = '';
    $scope.assign = '';
    $scope.totaltime = '';
    ...
    {
    $http({
    url: '<?php echo base_url(); ?>freelancer/gettasktime',
    method: "POST",
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    }
    }).then(function(response)
    {
      if(response.data.success == "false")
      {
        <?php if($this->session->userdata['clientloggedin']['type'] == 2 || $this->session->userdata['clientloggedin']['access'] == 5)
            {
              ?>
         angular.element('#companyinfoupdate').modal('show');
         <?php } ?>
       }
    ...
    $scope.datedata = function(startdate,duedate)
    {
      var dates = new Date(Date.parse(startdate))
      var startdate = '' + dates.getDate() + '-' + (dates.getMonth()+1) + '-' + dates.getFullYear();
      var dates1 = new Date(Date.parse(duedate))
      var duedate = '' + dates1.getDate() + '-' + (dates1.getMonth() + 1) + '-' + dates1.getFullYear();
    ...
    {
      $http({
        url: '<?php echo base_url(); ?>freelancer/getsession',
        method: "POST",
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        }
    ...
    $scope.submittodo = function()
    {
      ...
      // $scope.file == ''
      if($scope.name == '' ||  $scope.department == '' || $scope.team == '' || $scope.description == ''  || $scope.date == '' || $scope.duedate == '' )
      {
        error = true;
      }
    ...
    {
      var obj = { page :$scope.page,perpage:$scope.perpage,status:$scope.sstatus,priority:$scope.spriority,assign:$scope.aassign };
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.start = response.data.start;
          $scope.total      = response.data.pcount;
          $scope.alltasktotal = response.data.pcount;
          if($scope.alltodo)
          {
            for(var a in $scope.alltodo)
            {
              ...
              else
              {
                ...
                $scope.alltodo[a].disable = 0;
                $scope.alltodo[a].showbutton = 0;
    ...
    // current
        ...
        $scope.cgettodo = function()
        {
          $scope.currenttodo = [];
          $scope.history = [];
          var obj = { page :$scope.cpage,perpage:$scope.cperpage,status:$scope.csstatus,priority:$scope.cspriority,assign:$scope.assign };
          $http({
            ...
            if(response.data.message == "true")
            {
              ...
              $scope.currenttasktotal = response.data.pcount;
              $scope.duetask = response.data.duetask;
              ...
              if($scope.currenttodo)
              {
                for(var a in $scope.currenttodo)
                {
                  ...
                  else if($scope.currenttodo[a].assignedTo != $scope.userId)
                  {
                 ...
                 for(var b in $scope.currenttodo)
                 {
                   ...
                   if($scope.currenttodo[b].status == 6)
                   {
                     $scope.currenttodo[b].disabled = 1;
                    }
                  }
    ...
    $scope.delete = function()
    {
      ...
      $http({
        ...
        {
          angular.element('#confirm').modal('hide');
          $.notify("Task Already In Progress", "error");
        }
      });
    }
    ...
    $scope.edittodo = function(id)
    {
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.ended = $scope.edittodo1.ended;
          $scope.started = $scope.edittodo1.started;
    ...
    $scope.updatetodo = function()
    {
      ...
      if($scope.name1 == '' ||  $scope.department1 == '' || $scope.team1 == '' || $scope.description1 == '' ||  $scope.date1 == '' || $scope.duedate1 == '' )
      {
        error = true;
      }
      ...
      var obj = {id:$scope.edittodo1.id, name:$scope.name1,startDate:$scope.date1,dueDate:$scope.duedate1,priority:$scope.priority1,dept:$scope.department1,assignedTo:$scope.team1,description:$scope.description1,file:$scope.file };
      angular.element('.preloader').show();
      $http({
        url: '<?php echo base_url(); ?>freelancer/updatetodo',
        method: "POST",
    ...
    $scope.startTime = function($event)
    {
      ...
      var b = a[0].selectedOptions[0];
      var c = b.getAttribute('data-id');
      var taskId = b.getAttribute('data-task');
      ...
      if(status != '')
      {
        if(status != 6)
        {
          var obj = {  id : c,status:status,taskId:taskId }
         $http({
       ...
       {
         angular.element('#completeconfirm').modal('show');
       }
    }
    }

    $scope.taskCompleted = function($event)
    {
          var obj = {  id : $scope.id,status:$scope.status,taskId:$scope.taskId }
         $http({
         url: '<?php echo base_url(); ?>freelancer/todotaskStart',
         method: "POST",
         data:obj,
         headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
           ...
           {
            $scope.cgettodo();
            angular.element('#completeconfirm').modal('hide');
            $.notify("Task Updated Successfully", "success");
            }
         });
...
$scope.confirmApprovedDsr = function ($event)
{
  $scope.dsrStatus = $event.value;
  var  id = angular.element($event).val();
  var a = angular.element($event);
  var b = a[0].selectedOptions[0];
  $scope.dsrId = b.getAttribute('data-id');
  $scope.key = b.getAttribute('data-key');
  $scope.ttype = id;
  if($scope.ttype != 0 && $scope.ttype != '')
  {
  angular.element('#approvedconfirm').modal('show');
  }
...
$scope.action = function()
{
  ...
  if(error == true)
  {
   ...
   var obj = { dsrId :$scope.dsrId,approved:$scope.ttype,remarks:$scope.remark };
  $http({
    ...
    if(response.data.message =="true")
    {
      $scope.history[$scope.key].approved = $scope.ttype;
      angular.element('#approvedconfirm').modal('hide');
      if($scope.ttype == 1)
      {
      $.notify("Timesheet Approved Successfully", "success");
      }
      else if($scope.ttype == 2)
      {
...
$scope.viewtask = function(id,type)
{
   if(type == 1)
   {
    $scope.viewdata = $scope.alltodo[id];
   }
   else if(type == 2)
   {
     $scope.viewdata = $scope.currenttodo[id];
   }
 ...
 $scope.reassign = function (id)
 {
   ...
   var obj = { id :id };
   $http({
     url: '<?php echo base_url(); ?>freelancer/editReassigntodo',
     method: "POST",
     data :obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
     ...
     if(response.data.message == "true")
     {
       ...
       angular.element('#reassign').modal('show');
     }
     else
     {
       $.notify("Task Already In Progress ", "error");
 ...
 $scope.reassignsubmit = function()
 {
   $scope.submitl = true;
   var error = false;
   $scope.date1 = angular.element('#date3').val();
   $scope.duedate1 = angular.element('#duedate3').val();

   if($scope.department1 == '' || $scope.team1 == '' ||  $scope.name1 == '' || $scope.date1 == '' || $scope.duedate1 == '' )
   {
     error = true;
   }
   ...
   var obj = { id:$scope.id,dept:$scope.department1,assignedTo:$scope.team1,status:'2',ended:'0',started:'0',name:$scope.name1,startDate:$scope.date1,dueDate:$scope.duedate1};

   angular.element('.preloader').show();
   $http({
     url: '<?php echo base_url(); ?>freelancer/Reassigntodosave',
     method: "POST",
     data: obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
     ...
     {
       angular.element('.preloader').hide();
       angular.element('#reassign').modal('hide');
  ...
  $scope.showhistory = function (id,userId)
  {
    ...
    if(userId == $scope.userId)
    {
       ...
       angular.element('.preloader').show();
       $http({
         url: '<?php echo base_url(); ?>freelancer/gettodohistory',
         method: "POST",
         data: obj,
         headers: {
           'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
         ...
         if(response.data.success == "true")
         {
           ...
           if($scope.history)
           {
             ...
             {
               if($scope.history[i].approved == 0)
               {
                $scope.history[i].approved = '';
               }
             }
           }
  ...
  $scope.showhistoryBilling = function(key,userId)
  {
    if(userId == $scope.userId)
    {
      var id = $scope.history[key].id;
      var taskId = $scope.history[key].taskId;
      var assignedTo = $scope.history[key].assignedTo;

       var obj = { id:id,taskId:taskId,userId:assignedTo};
       angular.element('.preloader').show();
       $http({
         url: '<?php echo base_url(); ?>freelancer/gettodohistoryBilling',
         method: "POST",
         data: obj,
         headers: {
           'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
         ...
         {
           angular.element('.preloader').hide();
           $scope.historybilling = response.data.result;
           // $scope.totaltime = response.data.totaltime;
           $('#historyBilling').modal('show');
         }
       });
     }
  }

  $scope.assignSearch = function ($event)
  {
    $scope.page = 1;
    $scope.csstatus ='';
    $scope.assign = $event.value;
    $scope.cgettodo();

  }

  $scope.allassignSearch = function ($event)
  {
    $scope.page = 1;
    $scope.aassign = $event.value;
    $scope.gettodo();
...
app46.controller('myCtrt46', function($scope,$window,$http,$interval) {
  ...
  $scope.sclient = '';
  $scope.ownercontract =[];
  $scope.contactmilestone = [];
  $scope.ownmilestone = [];
  $scope.contacttask = [];
  $scope.owntask = [];
  $scope.ownerhourlyprice = [];
  $scope.showmonthselect = 1;
  $scope.invoiceno ='';
  $scope.typingLENGTH =800;
  $scope.lastTypingTime='';
  $scope.typing = false;
  $scope.getuserlocalcurrency = [];
  $scope.showrecurring = 0;
  $scope.recurringType ='';
  $scope.duration ='';
  $scope.alltotalamount = 0;
  $scope.milestone = '';
  $scope.projectType = '';
  $scope.countryCode = '';
  $scope.countryClass ='';
  $scope.recurringevery ='';
  $scope.end ='';
  $scope.endNever = '';
  $scope.endAfter = '';
  $scope.Afterduration = '';
...
$scope.clickendNever = function(id)
{
  if(id == 1)
  {
    $scope.endNever = 1;
...
$scope.addinvoice = function ()
{
  $http({
    ...
    $scope.plan = response.data.result;
    if($scope.plan.invoice != $scope.total && $scope.plan.invoice >= $scope.total)
    {
       $window.location.href ="<?php echo base_url(); ?>freelancer/invoice/create";
    }
    else
    {
      $("#packageUpgrade").modal('show');
...
$scope.changeDiscount = function($event)
{
  if($event.value != '')
  {
  $scope.discounttype = $event.value;
  $scope.counttotalhour();
  }
}

$scope.changerecurringtype = function ($event)
{
  $scope.recurringevery = $event.value;
}

$scope.endclick = function ($event)
{
  if($event.target.checked ==  true)
  {
    $scope.end = 1;
...
$scope.recurringclick = function()
{
  if($scope.showrecurring == 0)
  {
    $scope.showrecurring = 1;
  }
  else
  {
    $scope.showrecurring = 0;
...
{
  var obj = { invoiceId :id,receivedAmount:val };
 $http({
   url: '<?php echo base_url(); ?>freelancer/invoicereceivedSave',
   method: "POST",
   data :obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
...
$http({
  url: '<?php echo base_url(); ?>freelancer/getinvoiceSuggestionClient',
  method: "POST",
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  }
...
$scope.clickadvanceSearch =  function()
{
  ...
  $http({
    url: '<?php echo base_url(); ?>freelancer/getlastinvoiceNo',
    method: "POST",
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    }
  ...
  $http({
    url: '<?php echo base_url(); ?>freelancer/getActiveInvoiceClient',
    method: "POST",
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    }
  ...
  {
    var obj = { invoiceId:id };
    angular.element('.preloader').show();
    $http({
      url: '<?php echo base_url(); ?>freelancer/sendinvoice',
      method: "POST",
      data: obj,
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  ...
  $scope.submitinvoice = function()
  {
    $scope.submitl = true;
    var error = false;
    $scope.recurringType = angular.element('.recurringtype').val();
    $scope.duration = angular.element('.duration').val();
    $scope.contract = angular.element('.contract').val();
    $scope.milestone = angular.element('.milestone').val();
    var phone = angular.element("#phone").val();
    $scope.Afterduration = angular.element('.afterduration').val();
    ...
    if($scope.reference == '' || $scope.invoiceno == '')
    {
      error = true;
    }
    ...
    if(pclass == "form-control ng-valid ng-dirty ng-valid-parse ng-touched ng-not-empty error11")
    {
      return false;
    }
    ...
    var obj = { recipient:$scope.recipient,name:$scope.name,email:$scope.email,phone:$scope.phone,address:$scope.address,contractId:$scope.contract,milestoneId:$scope.milestone,projectType:$scope.projectType,task:$scope.task,amount:$scope.totalamount,discount:$scope.discount,discounttype:$scope.discounttype,tax:$scope.tax,payable:$scope.payable,currencyId:$scope.currency,taxAmount:$scope.taxAmount,discountAmount:$scope.discountAmount,reference:$scope.reference,invoiceNo:$scope.invoiceno,recurring:$scope.recurringType,duration:$scope.duration,countryCode:$scope.countrycode,countryClass:cl,every:$scope.recurringevery,endNever:$scope.endNever,endAfter:$scope.endAfter,endAfterDuration:$scope.Afterduration,showrecurring:$scope.showrecurring,end:$scope.end };
    angular.element('.preloader').show();
    $http({
      ...
      if(response.data.message == "true")
      {
        ...
        function callAtInterval()
        {
          $window.location.href = '<?php echo base_url(); ?>invoice/<?php echo $this->session->userdata['clientloggedin']['url']; ?>';
        }

      }
      else if(response.data.already == "true")
      {
          $.notify("Invoice No. is Already Exists.", "error");
      }
  ...
  {
      $scope.alltotalamount = 0;
    var obj = { page :$scope.page,perpage:$scope.perpage,startdate:$scope.startdate,enddate:$scope.enddate,name:$scope.sclient };
    $http({
      ...
      if(response.data.message == "true")
      {
        ...
        $scope.start = response.data.start;
        $scope.total      = response.data.pcount;
        $scope.alltotalamount = response.data.total;
        if($scope.allinvoice)
        {
          for(var i in $scope.allinvoice)
          {
            if($scope.allinvoice[i].paymentReceived)
            {
              $scope.allinvoice[i].disabled = 0;
            }
            else if(!$scope.allinvoice[i].paymentReceived)
            {
              $scope.allinvoice[i].disabled = 1;
            }
          }
        }
  ...
  $scope.getMonthinvoice = function()
 {
 ...
 var obj = {  page:$scope.apage,month:$scope.month,year:$scope.year};
$http({
  url: '<?php echo base_url(); ?>freelancer/getMonthInvoice',
  method: "POST",
  data:obj,
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
  ...
  if(response.data.message == "true")
  {
    ...
    if($scope.monthEx)
    {
      for(var i in $scope.monthEx)
      {
        if($scope.monthEx[i].paymentReceived)
        {
          $scope.monthEx[i].disabled = 0;
        }
        else if(!$scope.monthEx[i].paymentReceived)
        {
          $scope.monthEx[i].disabled = 1;
        }
      }
    }
...
if($scope.atotal > 10)
{
 ...
 else
 {
  ...
  $scope.getcontract = function ($event)
  {
   ...
   var  projecttype = $scope.allclient[c].projectType;
    $scope.projectType = projecttype;
     if(projecttype == "contract")
   {
    var obj = {  id : id,projectType:projecttype  };
   ...
   else if(projecttype == "own")
   {
    ...
    else if(projecttype == "gig")
    {
      var obj1 = {  clientId : id  };

      $http({
       url: '<?php echo base_url(); ?>freelancer/getgigproject',
       method: "POST",
       data: obj1,
       headers: {
         'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
       ...
       if(response.data.success == "true")
       {
          $scope.gigcontract = response.data.result;
          // $scope.task = [];
          // for(var i in $scope.gigcontract)
          // {
          //   var a = {};
          //    a['task'] = $scope.gigcontract[i]['name'];
          //    a['hours'] = $scope.gigcontract[i]['hours'];
          //    a['hourly'] = $scope.gigcontract[i]['hourlyPrice'];
          //    a['amount'] = $scope.gigcontract[i]['amount'];
          //    $scope.task.push(a);
          // }
          // $scope.counttotalhour();
        }
  ...
  $scope.getmilestone = function ($event)
  {
      ...
      {
        var type = 2;
        $scope.ownerhourlyprice = $scope.ownercontract[key]['hourlyPrice'];
      }
      else if(c == "gig")
      {
        var type = 3;
     ...
     if(id != '')
     {
      ...
      }).then(function(response)
      {
        if(response.data.success == "true")
        {
           if(type == 1)
           {
           $scope.contactmilestone = response.data.result;
           }
           else if(type == 2)
           {
            $scope.ownmilestone = response.data.result;
           }
           // else if(type == 3)
           // {
           //   $scope.gigmilestone = response.data.result;
           //   $scope.task = [];
           //   for(var i in $scope.gigmilestone)
           //   {
           //     var a = {};
           //      a['task'] = $scope.gigmilestone[i]['name'];
           //      a['hours'] = $scope.gigmilestone[i]['hours'];
           //      a['hourly'] = $scope.gigmilestone[i]['hourlyPrice'];
           //      a['amount'] = $scope.gigmilestone[i]['amount'];
           //      $scope.task.push(a);
           //   }
           //   $scope.counttotalhour();
           // }
        ...
        else
        {
          if(type == 1)
          {
            $scope.task = [];
            var a = {};
             a['task'] = $scope.allcontract[key]['jobTitle'];
             a['hours'] = $scope.allcontract[key]['jobEstimateHours'];
             a['hourly'] = $scope.allcontract[key]['jobEstimateHourlyPrice'];
             a['amount'] = $scope.allcontract[key]['jobBudget'];
             $scope.task.push(a);
            $scope.counttotalhour();
          }
        }
  ...
  $scope.gettask = function ($event)
  {
      ...
      $http({
        url: '<?php echo base_url(); ?>freelancer/gettask',
        method: "POST",
        data: obj,
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
         ...
         {
           var  contracttask = [];
          contracttask = response.data.result;
          if(contracttask.length != 0)
          {
            $scope.task = [];
            for(var i in contracttask)
            {
              var a = {};
               a['task'] = contracttask[i]['name'];
               a['hours'] = contracttask[i]['hours'];
               a['hourly'] = contracttask[i]['hourlyPrice'];
               a['amount'] = contracttask[i]['amount'];
               $scope.task.push(a);
            }
            $scope.counttotalhour();
          }
         ...
         {
           $scope.owntask = response.data.result;
           if($scope.owntask.length != 0)
           {
               $scope.task = [];
             for(var i in $scope.owntask)
             {
               var a = {};
                a['task'] = $scope.owntask[i].name;
                a['hours'] = $scope.owntask[i].hours;
                a['hourly'] = $scope.ownerhourlyprice;
                a['amount'] = $scope.ownerhourlyprice * $scope.owntask[i].hours;
                $scope.task.push(a);
             }
             $scope.counttotalhour();
  ...
  $scope.getgigtask = function ($event)
  {
    var  id = angular.element($event).val();
    var a = angular.element($event);
    var b = a[0].selectedOptions[0];
    ...
    $scope.task = [];
    var a = {};
     a['task'] = $scope.gigcontract[key].name;
     a['hours'] = $scope.gigcontract[key].hours;
     a['hourly'] = $scope.gigcontract[key].hourlyPrice;
     a['amount'] = $scope.gigcontract[key].amount;
     $scope.task.push(a);
     $scope.counttotalhour();
    ...
    $scope.getclientProfile = function(key)
    {
      ...
      $scope.address = $scope.allclient[key].address;
      $scope.phone = $scope.allclient[key].phone;
      if($scope.allclient[key].countryCode)
      {
        $('.iti__selected-flag').attr("title",$scope.allclient[key].countryCode);
        $('.iti__selected-flag .iti__flag').removeClass('iti__us');
        $('.iti__selected-flag .iti__flag').addClass($scope.allclient[key].countryClass);
      }
    }
  ...
  $scope.searchdate = function ()
  {
    ...
    $scope.moonthwiseshow = 0;
    $scope.advanceSearchshow = 0;
    $scope.startdate = angular.element(".invoicestartdate").val();
    $scope.enddate = angular.element(".invoiceenddate").val();
    if($scope.startdate)
    {
      if($scope.enddate)
      {
 ...
 $scope.changereceived = function ($event)
 {
   var  status = angular.element($event).val();
   var a = angular.element($event);
   var b = a[0].selectedOptions[0];
   var c = b.getAttribute('data-id');
   var obj = {  invoiceId : c,paymentReceived:status  };
   if(status != '')
   {
    $http({
     url: '<?php echo base_url(); ?>freelancer/invoiceReceivedPaymentChange',
     method: "POST",
     data: obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   ...
   }).then(function(response)
   {
      if(response.data.success == "true")
       {
        $.notify("Invoice payment mode updated successfully", "success");
        $scope.getinvoice();
        $scope.getMonthinvoice();
...
if(!empty($projectId))
{
  ...
  app48.controller('myCtrt48', function($scope,$window,$http,$interval) {
    ...
    $scope.updateproject = function()
    {
      ...
      var n = pclass.search("dddddd");

      if(pclass == "form-control phonenumber ng-valid ng-not-empty ng-touched ng-dirty ng-valid-parse error11")
      {
        return false;
      }
      ...
      $http({
        ...
        if(response.data.success == "true")
        {
          ...
          function callAtInterval()
          {
            $window.location.href = '<?php echo base_url(); ?>project/<?php echo $this->session->userdata['clientloggedin']['url']; ?>';
          }
        }
        else if(response.data.message == "false")
        {
    ...
    $scope.getproject = function()
    {
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.upfront = $scope.project.upfrontAmount;
          ...
          if($scope.m1.length != 0)
          {
             $scope.milestones = [];
            for(var i in $scope.m1)
            {
              $scope.milestones.push({
               title : $scope.m1[i]['name'],
               hours : $scope.m1[i]['hours'],
               taskId : $scope.m1[i]['taskId'],
               task : [],
               button:'',
...
app49.controller('myCtrt49', function($scope,$window,$http,$interval) {
  ...
  $scope.changepaid = function ($event)
  {
  ...
  $scope.updateinvoice = function()
  {
    ...
    if($scope.name == '' || $scope.email == '' || $scope.address == '' || $scope.phone == ''  || $scope.contract == '' ||  $scope.amount == ''  || $scope.currency == '' )
    {
      error = true;
    }
    ...
    var obj = { reference:$scope.reference,invoiceId:$scope.invoice.invoiceId,status:$scope.status,recipient:$scope.recipient,name:$scope.name,email:$scope.email,phone:$scope.phone,address:$scope.address,contractId:$scope.contract,task:$scope.task,amount:$scope.totalamount,discount:$scope.discount,discounttype:$scope.discounttype,tax:$scope.tax,payable:$scope.payable,currencyId:$scope.currency,taxAmount:$scope.taxAmount,discountAmount:$scope.discountAmount,paymentReceived:$scope.paymentReceived,status:$scope.status,recurring:$scope.recurringType,duration:$scope.duration,countryCode:$scope.countrycode,countryClass:cl,invoiceNo:$scope.invoiceno,showrecurring:$scope.showrecurring };
    angular.element('.preloader').show();
    $http({
  ...
  $scope.getinvoice = function()
  {
    ...
    $http({
      ...
      if(response.data.message == "true")
      {
        ...
        $scope.getcontractsedit($scope.invoice.recipient);
        ...
        if($scope.invoice.discountType != 0)
        {
        $scope.discounttype = $scope.invoice.discountType;
        }
        else if($scope.invoice.discountType == 0)
        {
          $scope.discounttype = '';
        }
        ...
        $scope.reference = $scope.invoice.reference;
        $scope.invoiceno = $scope.invoice.invoiceNo;
        $scope.status = $scope.invoice.status;
        $scope.paymentReceived = $scope.invoice.paymentReceived;
        $scope.contract = $scope.invoice.contractId;
        $scope.projectType = $scope.invoice.projectType;

        // if($scope.invoice.projectType == "own")
        // {
        //   $scope.allcontract = $scope.invoice.contract;
        // }
        // else if($scope.invoice.projectType == "contract")
        // {
        //   $scope.ownercontract = $scope.invoice.contract;
        // }
        if($scope.status == 1)
        {
           $scope.disabled = 0;
        ...
        if($scope.status == 1)
        {
         ...
         if($scope.invoice.recipient == 0)
         {
          ...
          if($scope.invoice.countryCode)
          {

          $('.iti__selected-flag').attr("title",$scope.invoice.countryCode);
          $('.iti__selected-flag .iti__flag').removeClass('iti__us');
          $('.iti__selected-flag .iti__flag').addClass($scope.invoice.countryClass);
          }

         if($scope.invoice.recurringType)
         {
            $scope.recurringType = $scope.invoice.recurringType;
            $scope.duration = $scope.invoice.duration;
            $scope.showrecurring = 1;
            $scope.recurringevery = $scope.invoice.every;
            $scope.endNever = $scope.invoice.endNever;
            $scope.endAfter = $scope.invoice.endAfter;
            $scope.Afterduration = $scope.invoice.endAfterDuration;
            $scope.end = $scope.invoice.end;
  ...
  $scope.getcontractsedit = function(id)
  {
    var obj = {  id : id  };
 ...
 $scope.gettask = function ($event)
 {
     ...
     $http({
       ...
       headers: {
        ...
        if(type == 1)
        {
         $scope.contacttask = response.data.result;
         if($scope.contracttask.length != 0)
         {
           $scope.task = [];
           for(var i in $scope.contracttask)
           {
             var a = {};
              a['task'] = $scope.contracttask[i]['taskTitle'];
              a['hours'] = $scope.contracttask[i]['taskHours'];
              a['hourly'] = $scope.contracttask[i]['taskHourlyPrice'];
              a['amount'] = $scope.contracttask[i]['taskPrice'];
              $scope.task.push(a);
           }
           $scope.counttotalhour();
         }
...
// employee dsr mobiscroll-datetime', 'mobiscroll-form
...
$scope.viewdescription = function (id)
{
  ...
  $http({
    ...
    if(response.data.success == "true")
    {
      $scope.taskdescription = response.data.result.taskDetail;
      $scope.taskremark = response.data.result.remarks;
      angular.element('#view').modal('show');
    }
  });
}
...
$scope.dsr.push({
    ...
    $scope.checkdescription = function (val,key)
    {
      var currentVal = '';
      var currentVal1 ='';
      ...
      currentVal = currentVal.replace(regex, '');
       ...
       if($scope.dsr.length != 0)
       {
         for(var a in $scope.dsr)
         {
           if(a != key)
           {
             var currentVal1 = $scope.dsr[a].taskDetail.trim();
             currentVal1 = currentVal1.replace(regex, '');
             if(currentVal1 == currentVal)
             {
               $scope.dsr[key].unique = 1;
             }
             else
             {
               $scope.dsr[key].unique = 0;
             }
           }
         }
       }

       if($scope.dsr[key].unique == 0)
       {
    ...
    $scope.checktask = function (val,key)
    {
      var currentVal = '';
       var currentVal = val.trim();
       var regex = /[.,\s]/g;
       ...
       if(val.length > 25)
       {
        $scope.dsr[key].tmin = 1;
       }
       else
       {
         $scope.dsr[key].tmin = 0;
       }
    }
    ...
    {
      $http({
        url: '<?php echo base_url(); ?>freelancer/getUserTodayDsr',
        method: "POST",
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        }
      }).then(function(response)
      {
        if(response.data.message == "true")
        {
          var todaydsr = response.data.result;
          $scope.dsrdate = response.data.date;
            $scope.leave = response.data.leave;
           $scope.dsr = [];
           if(todaydsr.length != 0)
          {
            $scope.dsr = [];
            $scope.totalhours = 0;
            for(var i in todaydsr)
            {
              $scope.dsr.push({
               projectId :todaydsr[i].projectId,
               time : todaydsr[i].time,
               task : todaydsr[i].task,
               taskDetail :todaydsr[i].taskDetail,
               status : todaydsr[i].status,
               approved : todaydsr[i].approved,
               already : 1,
               timeerror : 0,
               unique : 0,
               min:0,
               tmin:0,
               includeSalary:'',
               type :todaydsr[i].type ,
                  });

                var a = todaydsr[i].time.split(":");
                var hours = a[0] * 60;
                var minutes = a[1];
                $scope.totalhours += hours+ + +minutes;
            }

            var h = parseInt($scope.totalhours / 60);
            if(h < 10)
            {
              h = '0'+h;
            }
            var m = parseInt($scope.totalhours % 60);
            if(m < 10)
            {
              m ='0'+m;
            }
            $scope.totalhours = h+':'+m;
          }
        ...
        else
        {
         ...
         angular.element('#adddsr').modal('show');
      })
    }

    $scope.keyupcounthour = function(val,key)
    {
      var typingTimer = (new Date()).getTime()
       ...
       var timeDiff    = typingTimer - $scope.lastTypingTime;
        ...
        $interval(function(){
         ...
         var timeDiff    = typingTimer - $scope.lastTypingTime;
         if (timeDiff   >= $scope.typingLENGTH && $scope.typing) {
           $scope.counthours(val,key);
           $scope.typing = false;
         }
          },$scope.typingLENGTH);
    }

    $scope.counthours = function(val,key)
    {
      var isValid = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test(val);

       if (isValid)
       {
        $scope.dsr[key].timeerror = 0;
       }
       else
       {
         $scope.dsr[key].timeerror = 1;
       }
      ...
      if($scope.dsr)
      {
        ...
        var h = "00";
        var m = "00";
        for(var i in $scope.dsr)
        {
          var a = $scope.dsr[i].time.split(":");
          var hours = a[0] * 60;
          var minutes = a[1];
            if(hours || minutes)
            {
      ...
      if($scope.totalhours)
      {
        ...
        var a1 = $scope.working.workingHour.split(":");
        var hours1 = a1[0] * 60;
        var minutes1 = a1[1];
        if(hours1 || minutes1)
        {
          var workinghours = +hours1 + +minutes1;
        }

        if(totalhours < workinghours)
        {
          $scope.workingerror = true;
        }
        else
        {
          $scope.workingerror = false;
    ...
    $scope.getdatewisedsr = function ()
    {
      $scope.dsrdate = angular.element('.dsrdate').val();
      var obj = { dsrdate:$scope.dsrdate };
      $http({
        url: '<?php echo base_url(); ?>freelancer/getUserTodayDsr',
        method: "POST",
        data:obj,
           ...
           if(todaydsr.length != 0)
          {
            ...
            for(var i in todaydsr)
            {
              $scope.dsr.push({
               ...
               tmin:0,
               min:0,
               includeSalary:todaydsr[i].includeSalary,
            ...
            totalhours = parseInt(+hours) + parseInt(+minutes) + parseInt(totalhours);
...
{
  $http({
    url: '<?php echo base_url(); ?>freelancer/getdsrproject',
    method: "POST",
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    }
...
{
  var obj = { perpage:$scope.perpage,page :$scope.page,startdate:$scope.startdate,enddate:$scope.enddate };
  $http({
...
$scope.alldsr1 = function()
{
  var obj = { page :$scope.page1,startdate:$scope.startdate1,enddate:$scope.enddate1 };
  $http({
    url: '<?php echo base_url(); ?>freelancer/getAllEmployeeDsr',
    method: "POST",
    data :obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    ...
    if(response.data.message == "true")
    {
      $scope.allemp = response.data.result;
      $scope.start1 = response.data.start;
      $scope.total1      = response.data.pcount;
      $scope.startdate1 = response.data.startdate;
      $scope.enddate1 = response.data.enddate;

      if($scope.page1 == 1)
      $scope.pagination1($scope.total1);
    }
    else
    {
      $scope.allemp = [];
...
$scope.savedsr = function()
{
  ...
  if($scope.dsr)
  {
    for(var i in $scope.dsr)
    {
      if($scope.dsr[i].projectId == '' || $scope.dsr[i].task == '' || $scope.dsr[i].taskDetail == '' || $scope.dsr[i].status == '' || $scope.dsr[i].time == '' || $scope.dsr[i].unique == 1 || $scope.dsr[i].min == 1 || $scope.dsr[i].tmin == 1)
      {
        error = true;
      }
      var isValid = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.dsr[i].time);

       if (isValid)
       {
        $scope.dsr[i].timeerror = 0;
       }
       else
       {
         $scope.dsr[i].timeerror = 1;
         error = true;
         return true;
       }
    }
  ...
  var obj = { dsr:$scope.dsr,date:$scope.dsrdate };
  angular.element('.preloader').show();
  $http({
...
$scope.documentUpload = function ($event)
{
 ...
 $scope.search = function ()
 {
   $scope.startdate = angular.element('.emdsrstartdate').val();
   $scope.enddate = angular.element('.emdsrenddate').val();
 ...
 {
   $scope.startdate1 = angular.element('.emdsrstartdate1').val();
   $scope.enddate1 = angular.element('.emdsrenddate1').val();
 ...
 $scope.changeProject = function ($event)
 {
   var  id = angular.element($event).val();
   var a = angular.element($event);
   var b = a[0].selectedOptions[0];
   ...
   var k1 = b.getAttribute('data-key1');
   var salary = b.getAttribute('data-salary');
   $scope.dsr[k].type = c;
   $scope.dsr[k].projectId = id;
   $scope.dsr[k].includeSalary = salary;
   if(c == 6)
   {
     var time ='00:00';

     if($scope.allproject[k1].mm < 10)
     {
       $scope.allproject[k1].mm = '0'+$scope.allproject[k1].mm;
     }
     if($scope.allproject[k1].hh && $scope.allproject[k1].mm)
     {
        time = '0'+$scope.allproject[k1].hh+':'+$scope.allproject[k1].mm;
     }
     else if(!$scope.allproject[k1].hh  && $scope.allproject[k1].mm)
     {
        time = '00:'+$scope.allproject[k1].mm;
     }
     $scope.dsr[k].time = time;
     $scope.keyupcounthour(time,k);
   }
   else
   {
      $scope.dsr[k].time ='';
  ...
  $scope.viewdsr = function(id,date)
   {
     ...
     $http({
       url: '<?php echo base_url(); ?>freelancer/viewdsr',
       method: "POST",
       data :obj,
       headers: {
         'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
       ...
       if(response.data.message =="true")
       {
         $scope.dsrviewdata = response.data.result;
         angular.element('#viewdsr').modal('show');
       }
     });
   }

   $scope.removedsr = function (key)
   {
       $scope.dsr.splice(key,1);
       $scope.counthours1();
   }
...
$scope.reasonUpdate = function ()
{
  ...
  var obj = { dsrId :$scope.dsrId,approved:2,remarks:$scope.reason };
  angular.element(".preloader").show();
  ...
  $http({
    ...
    if(response.data.message == "true")
    {
      $scope.alldsr[$scope.key].taskdetail[$scope.key1].approvedby = response.data.name;
      $.notify("Dsr Status Upodated Successfully", "success");
      angular.element('#reasonbox').modal('hide');
      angular.element('#reason').val('');
    }
    else if(response.data.error == "true")
...
if(hours || minutes)
{
  $scope.working.workingHour = +hours + +minutes;
  // console.log($scope.working.workingHour);
}
}
});
...
$scope.getdsr = function()
{
  ...
  var obj = { page :$scope.page,startdate:$scope.startdate,enddate:$scope.enddate,perpage:$scope.perpage };
  $http({
    ...
    if(response.data.message == "true")
    {
      ...
      $scope.startdate = response.data.startdate;
      $scope.enddate = response.data.enddate;
      $scope.readonly = response.data.type;
      if($scope.page == 1)
      $scope.pagination($scope.total);
    }
    else
...
$scope.changeStatus = function($event)
{
  ...
  var id = b.getAttribute('data-id');
  var key = b.getAttribute('data-key');
  var key1 = b.getAttribute('data-key1');
  $scope.dsrId = id;
  $scope.key = key;
  $scope.key1 = key1;
  if(status != '' && id != 0)
  {
    ...
    var obj = { dsrId:id,approved:status};
  ...
  $http({
    ...
    if(response.data.message == "true")
    {
      $.notify("Dsr Status Updated Successfully", "success");
      $scope.alldsr[key].taskdetail[key1].approvedby = response.data.name;
    }
    else if(response.data.error == "true")
    {
      $.notify(response.data.msg, "error");
      $scope.alldsr[key].taskdetail[key1].approved = response.data.status;
...
$scope.action = function()
{
  ...
  if(error == true)
  {
   ...
   var obj = { dsrId :$scope.id,approved:$scope.type,remarks:$scope.remark };
  $http({
    url: '<?php echo base_url(); ?>freelancer/dsrApproved',
    method: "POST",
    data :obj,
...
$scope.dsrhistory = function (userId,date,key)
{
     $scope.selectedkey = key;
   var obj = { employeeId:userId,date:date};
   angular.element('.preloader').show();
   $http({
     url: '<?php echo base_url(); ?>freelancer/dsrtaskdetail',
     method: "POST",
     data: obj,
     headers: {
       'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
     ...
     {
       angular.element('.preloader').hide();
       $scope.alldsr[date]['taskdetail'] = response.data.result;
     }
   });
...
{
  $scope.taskdetail = [];
  $scope.startdate = angular.element('.dsrstartdate').val();
  $scope.enddate = angular.element('.dsrenddate').val();
  if($scope.startdate != '' && $scope.enddate != '')
  {
  $scope.page =1;
  $scope.getdsr();
...
$scope.adjustmentTimekeyup = function (val,id,key,key2)
{
  var typingTimer = (new Date()).getTime()
  ...
  $interval(function(){
    ...
    var timeDiff    = typingTimer - $scope.lastTypingTime;
    if (timeDiff   >= $scope.typingLENGTH && $scope.typing) {
      $scope.adjustmentTime(val,id,key,key2);
...
$scope.adjustmentTime = function (val,id,key,key2)
{
  var isValid = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test(val);
   if (isValid)
   {
    $scope.timeerror = false;
    $scope.alldsr[key].taskdetail[key2].error = 0;
    var userId = $scope.alldsr[key].taskdetail[key2].employeeId;

   }
   else
   {
     $scope.alldsr[key].taskdetail[key2].error = 1;
     $scope.timeerror = true;
     return true;
   }


   var obj = { dsrId :id,adjustedTime:val,date:key,userId:userId };
  $http({
    url: '<?php echo base_url(); ?>freelancer/dsrTimeAdjustUpdate',
    method: "POST",
    data :obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    ...
    if(response.data.success == "true")
    {
      $scope.alldsr[key].dsr[$scope.selectedkey].adjusted = response.data.result;
    }
...
app53.filter('underscoreless', function () {
  return function (input) {
      if(input)
      {
      return input.split(' ').join('-');
...
$scope.addproject = function (project)
{
 ...
 $http({
  ...
  $http({
    ...
    if(response.data.message == "true")
    {
      ...
      for(var i in $scope.monthEx)
      {
         if($scope.monthEx[i].status == 2)
         {
         $scope.monthEx[i].disabled = 1 ;
         }
         else if($scope.monthEx[i].status == 1)
         {
          $scope.monthEx[i].disabled = 0 ;
         }
       }
  ...
  $scope.editincome = function(id)
  {
    ...
    $http({
      ...
      if(response.data.message == "true")
      {
        ...
        if($scope.editincomedata.deposited != 0)
        {
        ...
        if($scope.editincomedata.received != 0)
        {
        ...
        if($scope.editincomedata.receivedAmount != 0)
        {
  ...
  $scope.updateincome = function()
  {
    ...
    // console.log($scope.Receivedamount1);
 ...
 $scope.changedStatus1 = function($event)
 {
   var status = $event.value;
   if(status == 2)
   {
...
$scope.saveopening = function()
{
  ...
  console.log($scope.experience);
  console.log($scope.industry);
  console.log($scope.responsibility);
...
// jobopening
    ...
    app56.directive('mydatepicker1', function () {
    return {
      restrict: 'A',
      require: 'ngModel',
      link: function (scope, element, attrs, ngModelCtrl) {
    ...
    $scope.saverecruitment = function()
    {
      ...
      // || $scope.cv == ''
      if($scope.name == '' || $scope.email == '' || $scope.phone == '' || $scope.gender == '' || $scope.experience == '' || $scope.current == '' || $scope.expected =='' || $scope.birth == ''  || $scope.currency =='' || $scope.cv == '' || $scope.skill == '')
      {
        error = true;
      }
    ...
    $scope.editRecruitment = function(id)
    {
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
           ...
           $scope.skill1 = $scope.edit.candidateSkill;
    ...
    $scope.update = function()
    {
      ...
      if($scope.name1 == '' || $scope.email1 == '' || $scope.phone1 == '' || $scope.gender1 == '' || $scope.experience1 == '' || $scope.current1 == '' || $scope.expected1 ==''  || $scope.period1 == '' || $scope.birth1 == '' || $scope.cv1 == '' || $scope.currency1 == '' || $scope.skill1 == '' )
      {
        error = true;
      }
 ...
 $scope.addinterviewer1 = function (name,id)
 {
   ...
   if(!match)
   {
    ...
    {
      var obj = { page :$scope.page,position:$scope.sposition,status:$scope.sstatus,perpage:$scope.perpage,date:$scope.searchdate };
      $http({
    ...
    $scope.search = function()
    {
      $scope.searchdate = angular.element('#searchdate').val();
      $scope.getinterview();
    }
  ...
  $scope.statuschange = function ($event)
  {
    ...
    $scope.addannouncementopen = function ()
    {
      $scope.selectedemployee = [];
      $scope.disabled1 = false;
      angular.element('#addannouncement').modal('show');
    }
    ...
    $scope.getemployeekeyup = function()
    {
      ...
      $scope.removeEmployee1 = function(key)
      {
        $scope.selectedemployee.splice(key,1);
        if($scope.selectedemployee.length == 0)
        {
  ...
  $scope.checksendtoall1 = function()
  {
     if($scope.sendtoall)
     {
       $scope.disabled2 = false;
  ...
  $scope.get();
    ...
    $scope.receivedkeyup = function (val,id,projectId)
{
 var typingTimer = (new Date()).getTime()
 ...
 $interval(function(){
   ...
   var timeDiff    = typingTimer - $scope.lastTypingTime;
   if (timeDiff   >= $scope.typingLENGTH && $scope.typing) {
     $scope.receivedSave(val,id,projectId);
     $scope.typing = false;
   }
 },$scope.typingLENGTH);
}

$scope.receivedSave = function(val,id,projectId)
{
  var obj = { projectMilestoneId :id,amount:val,projectId:projectId };

 $http({
   url: '<?php echo base_url(); ?>freelancer/taskreceivedAmount',
   method: "POST",
   data :obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
...
if(response.data.success == "true")
{
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          if(milestone.length != 0)
          {
            ...
            {
              $scope.all.milestone[i].totalm = 0;
              for(var a in milestone[i].task )
              {
                ...
                $scope.all.milestone[i].totalm = $scope.all.milestone[i].totalm + +milestone[i].task[a].hours * $scope.all.hourlyPrice;
   ...
   $scope.delete = function()
   {
     ...
     $http({
       ...
       if(response.data.message == "true")
       {
         $scope.get();
         angular.element('#Delete').modal('hide');
         $.notify("Employee Increment Deleted Successfully", "success");
         $scope.page = 1;
       }
     });
   }
 ...
 $scope.get();
   ...
   $scope.ctrl = function()
   {
    ...
    $scope.convertproject =function(id,key)
    {
      $scope.leadId = id;
      $scope.leadkey = key;
      angular.element('#confirmproject').modal('show');
    }

    $scope.convertleadToProject = function ()
    {
      var obj = { leadId :$scope.leadId };
      $http({
        url: '<?php echo base_url(); ?>freelancer/leadConvertToProject',
        method: "POST",
        data :obj,
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        ...
        if(response.data.success == "true")
        {
          $scope.alllead.splice($scope.leadkey,'1');
          $.notify("Lead Converted To Project Successfully", "success");
          angular.element('#confirmproject').modal('hide');
    ...
    $scope.websitectrl = function($event)
    {
      $scope.website = $event.value;
      if(!$scope.website.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
      {
   ...
   $scope.save = function()
   {
     ...
     // || $scope.upload ==''
     if($scope.currency == ''  || $scope.empName =='' || $scope.clientName == '' || $scope.phone =='' || $scope.email =='' || $scope.website =='' || $scope.jobtitle =='' || $scope.jobtitle =='' || $scope.jobdescription =='' || $scope.remark =='' || $scope.budget =='' || $scope.date =='' || $scope.status ==''  || $scope.leadcapture =='' || $scope.skill.length == 0 || $scope.projecttype =='' || $scope.timezone =='')
     {
       error = true;
     }
...
else
{
 $scope.websitevalide = false;
   ...
   $scope.documentUpload = function ($event)
   {
     var files =$event.files;
     var type = files[0].type.split("/");
   if ($.inArray(type[1], ['vnd.openxmlformats-officedocument.wordprocessingml.document','msword','pdf','png','jpg','jpeg']) == -1)
   {
   ...
   {
     $http({
       url: '<?php echo base_url(); ?>freelancer/allleadteam',
       method: "POST",
       headers: {
         'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
       }
   ...
   $scope.ctrl = function()
{
  ...
  if(!email.match(/([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)\S+/))
  {
   ...
   $scope.save = function()
   {
     ...
     // || $scope.upload ==''
     if( $scope.clientName == '' || $scope.phone == '' || $scope.email == '' || $scope.website == ''  || $scope.jobtitle == '' || $scope.jobdescription == '' ||   $scope.leadcapture == '' || $scope.skill.length == 0 ||  $scope.projecttype == '' || $scope.timezone == '')
     {
       error = true;
     }
     ...
     if(pclass == "form-control ng-pristine ng-valid ng-not-empty error11 ng-touched")
     {
       return false;
     }
     ...
     $http({
       ...
       if(response.data.message == "true")
       {
         ...
         if($scope.m1)
         {
           ...
           for(var i in $scope.m1)
           {
             if($scope.m1[i]['currencyId'] != 0)
             {
               var a = $scope.m1[i]['currencyId'];
             }
             else
             {
                var a = '';
             }
             if($scope.m1[i]['employeeId'] != 0)
             {
              $scope.info.push({
   ...
   if ($.inArray(type[1], ['vnd.openxmlformats-officedocument.wordprocessingml.document','vnd.openxmlformats-officedocument.spreadsheetml.sheet','msword','pdf','png','jpg','jpeg']) == -1)
   {
    $scope.fileerror = true;
   }
   else
...
$scope.employeeused =0;
$scope.projectused = 0;
$scope.invoiceused = 0;
$scope.expenseused = 0;
$scope.packageused = 0;
$scope.portfolioused = 0;
$scope.testimonialused = 0;
$scope.casestudiesused = 0;
$scope.servicesused = 0;
$scope.industryused = 0;
// member
$scope.employeemin = '';
$scope.projectmin = '';
$scope.invoicemin = '';
...
{
  angular.element('#planUpgraded').modal('hide');
  location.reload();
}

$scope.getusedServices = function ()
{
$http({
 url: '<?php echo base_url(); ?>freelancer/getmembershipUsedData',
 method: "POST",
 headers: {
   'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
 }
}).then(function(response) {
  $scope.employeeused = response.data.employee;
  $scope.projectused = response.data.project;
  $scope.invoiceused = response.data.invoice;
  $scope.expenseused = response.data.expense;
  $scope.packageused = response.data.package;
  $scope.portfolioused = response.data.portfolio;
  $scope.testimonialused = response.data.testimonial;
  $scope.casestudiesused = response.data.casestudies;
  $scope.servicesused = response.data.services;
  $scope.industryused = response.data.industry;
...
{
$http({
 url: '<?php echo base_url(); ?>freelancer/getuserplan',
 method: "POST",
 headers: {
   'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
 }
  ...
  {
   $scope.plan = response.data.result;
   $scope.employeemin = $scope.plan.employee;
   $scope.projectmin = $scope.plan.project;
   $scope.expensemin = $scope.plan.expense;
   $scope.invoicemin = $scope.plan.invoice;

   $scope.package =response.data.result.package;
   $scope.packagemin =response.data.result.package;
   $scope.testimonialmin = response.data.result.testimonial;
   $scope.testimonial = response.data.result.testimonial;
   $scope.testimonialmax = response.data.result.testimonial;
   $scope.portfoliomin = response.data.result.portfolio;
   $scope.portfolio = response.data.result.portfolio;
   $scope.casestudiesmin = response.data.result.casestudies;
   $scope.casestudies = response.data.result.casestudies;
   $scope.servicesmin = response.data.result.services;
   $scope.services = response.data.result.services;
   $scope.industry = response.data.result.industry;
   $scope.industrymin = response.data.result.industry;


   $scope.employee = $scope.plan.employee;
   $scope.project = $scope.plan.project;
   $scope.expense = $scope.plan.expense;
   $scope.invoice = $scope.plan.invoice;
...
$scope.companyplan = function ()
{
  ...
  headers: {
   ...
   if(response.data.success == 'true')
   {
    ...
    $scope.packagemax =response.data.result.packageMax;
...
$scope.pagination = function ($event)
{
  ...
  $scope.search = function()
  {
    ...
    $scope.changeemp = function ($event)
    {
       ...
       $scope.employeetotal = parseInt($scope.employeepaid) * parseInt($scope.employeeprice);
       }
       else
       {
         $scope.employeetotal = 0;
       ...
       $scope.totalamount = $scope.employeetotal + $scope.projecttotal + $scope.expensetotal + $scope.invoicetotal + $scope.packagetotal + $scope.testimonialtotal + $scope.portfoliototal + $scope.casestudiestotal + $scope.servicestotal + $scope.industrytotal;

       angular.element('.selectedemployee').val($scope.employee);
       angular.element('.selectedamount').val($scope.totalamount);
       $scope.$apply();
    }
    ...
    $scope.changepro = function ($event)
    {
       ...
       $scope.projecttotal = parseInt($scope.projectpaid) * parseInt($scope.projectprice);
       }
       else
       {
         $scope.projecttotal = 0;
    ...
    $scope.changeinv = function ($event)
    {
        ...
        $scope.invoicetotal = parseInt($scope.invoicepaid ) * parseInt($scope.invoiceprice);
        }
        else
        {
          $scope.invoicetotal =0;
    ...
    $scope.changeex = function ($event)
    {
       ...
       $scope.expensetotal = parseInt($scope.expensepaid) * parseInt($scope.expenseprice);
       }
       else
       {
         $scope.expensetotal = 0;
    ...
    $scope.changepac = function ($event)
    {
       ...
       $scope.packagetotal = parseInt($scope.packagepaid) * parseInt($scope.packageprice);
       }
       else
       {
         $scope.packagetotal = 0;
    ...
    $scope.changecasestud = function ($event)
    {
       ...
       $scope.casestudiestotal = parseInt($scope.casestudiespaid) * parseInt($scope.casestudiesprice);
       }
       else
       {
         $scope.casestudiestotal = 0;
    ...
    $scope.changetestimonial = function ($event)
    {
       ...
       $scope.testimonialtotal = parseInt($scope.testimonialpaid) * parseInt($scope.testimonialprice);
       }
       else
       {
         $scope.testimonialtotal = 0;
    ...
    $scope.changeportfolio = function ($event)
    {
       ...
       $scope.portfoliototal = parseInt($scope.portfoliopaid) * parseInt($scope.portfolioprice);
       }
       else
       {
         $scope.portfoliototal = 0;
    ...
    $scope.changeindustry = function ($event)
    {
       ...
       $scope.industrytotal = parseInt($scope.industrypaid) * parseInt($scope.industryprice);
       }
       else
       {
         $scope.industrytotal = 0;
    ...
    $scope.changeservices = function ($event)
    {
       ...
       $scope.servicestotal = parseInt($scope.servicespaid) * parseInt($scope.servicesprice);
       }
       else
       {
         $scope.servicestotal = 0;
...
$scope.update = function ()
{
  ...
  var obj = { askQuestionId :$scope.viewdata.askQuestionId,answer:$scope.answer};
  $http({
    ...
    if(response.data.message == "true")
    {
      ...
      $scope.question = '';
      $scope.answer = '';
      angular.element('#viewaskquestion').modal('hide');
      $.notify("Answered the query successfully", "success");
...
$http({
  ...
  if(response.data.message == "true")
  {
    ...
    $scope.viewdata = response.data.result;
    CKEDITOR.instances['answer'].setData($scope.viewdata.answer);
...
$scope.changeStatus = function($event)
{
  ...
  if(status != '' && id != 0)
  {
  var obj = { askQuestionId:id,status:status};
  angular.element(".preloader").show();

  $http({
    url: '<?php echo base_url(); ?>freelancer/askquestionsStatusUpdate',
    method: "POST",
    data: obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    ...
    if(response.data.message == "true")
    {
      $.notify("Ask Question Status Updated Successfully", "success");
...
$scope.edit = function(id)
{
  ...
  $http({
   url: '<?php echo base_url(); ?>freelancer/checkgigbuy',
   method: "POST",
   data:obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    ...
    if(response.data.success == 'true')
    {
       $.notify("Gig Already Purchased", "error");
    }
    else
    {
      $window.location.href="<?php echo base_url(); ?>freelancer/gig-edit/"+id;
    }
      });
}
...
$scope.basicdescription = '';
$scope.basicprice = '';
$scope.basicduration = '';
$scope.basicexplain = '';
$scope.standarddescription = '';
$scope.standardprice = '';
$scope.standardduration = '';
$scope.standardexplain = '';
$scope.premiumdescription = '';
$scope.premiumexplain = '';
$scope.premiumduration = '';
$scope.premiumprice = '';
$scope.allcurrency = [];
$scope.image = [];
$scope.showbasic = 0;
$scope.showstandard = 0;
$scope.showpremium = 0;
...
$scope.basicadd = function ($event)
 ...
 $scope.selectedplan = function ($event,type)
 {
    if($event.target.checked ==  true)
    {
        if(type == 1)
 ...
 $scope.standardadd = function ($event)
  {
  $scope.standard.push({
    task : '',
    plan : 2,
  ...
  $scope.premiumadd = function ($event)
   {
   $scope.premium.push({
     task : '',
     plan : 3,
...
$scope.save = function ()
{
  ...
  if($scope.title == '' || $scope.description == '' ||  $scope.industry == '' || $scope.services == '' || $scope.currency =='' || $scope.image.lenth == 0)
  {
    error = true;
  }

  if($scope.showbasic == 1)
  {
   if($scope.basicprice == 0 || $scope.basicprice == '' ||  $scope.basicduration == '' || $scope.basicduration == 0  || $scope.basicexplain == '')
   {
    error = true;
   }


   for( var res in $scope.basic)
   {
     if($scope.basic[res]['task'] == ''  )
     {
       error = true;
     }
   }
 ...
 if($scope.showstandard == 2)
 {
   if( $scope.standardprice == 0 || $scope.standardprice == '' ||  $scope.standardduration == '' || $scope.standardduration == 0 || $scope.standardexplain == '')
   {
    error = true;
   }

     for( var res in $scope.standard)
     {
       if($scope.standard[res]['task'] == '' )
       {
         error = true;
       }
     }
  ...
  if($scope.showpremium == 3)
  {
    if( $scope.premiumprice == 0 || $scope.premiumprice == '' ||  $scope.premiumduration == '' || $scope.premiumduration == 0  || $scope.premiumexplain == '')
    {
     error = true;
    }

    for( var res in $scope.premium)
    {
        if($scope.premium[res]['task'] == ''  )
        {
          error = true;
        }
     }
  ...
  if($scope.showbasic == 0 && $scope.showstandard == 0 && $scope.showpremium == 0)
  {
    error = true;
  ...
  angular.element('.preloader').show();
  var obj = { title:$scope.title,image:$scope.image,currencyId:$scope.currency,description:$scope.description,industryId:$scope.industry,servicesId:$scope.services,basic:$scope.basic,standard:$scope.standard,premium:$scope.premium,basicPrice:$scope.basicprice,premiumPrice:$scope.premiumprice,basicDuration:$scope.basicduration,basicExplain:$scope.basicexplain,standardPrice:$scope.standardprice,standardDuration:$scope.standardduration,standardExplain:$scope.standardexplain,premiumDuration:$scope.premiumduration,premiumExplain:$scope.premiumexplain,showbasic:$scope.showbasic,showpremium:$scope.showpremium,showstandard:$scope.showstandard};
  $http({
...
app73.controller('myCtrt73', function($scope,$window,$http,$interval) {
 ...
 $http({
   ...
   if(response.data.message == "true")
   {
     ...
     $scope.currency = $scope.editdata.currencyId;
     if($scope.editdata.images.length != 0)
     {
       for(var a in $scope.editdata.images)
       {
        $scope.image.push($scope.editdata.images[a].image);
       }
     }
     ...
     if($scope.p)
     {
       ...
       for(var i in $scope.p)
       {
         if($scope.p[i].plan == 1)
         {
           $scope.basic = [];
           $scope.showbasic = 1;
           $scope.basicprice = $scope.p[i].amount;
           $scope.basicduration = $scope.p[i].hours;
           $scope.basicexplain = $scope.p[i].description;

           for(var j in $scope.p[i].task)
            	{
          		   $scope.basic.push({
            		 	task : $scope.p[i].task[j].name,
            		 });
            	}
         }
         else if($scope.p[i].plan == 2)
         {
           $scope.standard = [];
           $scope.showstandard = 2;
           $scope.standardprice = $scope.p[i].amount;
           $scope.standardduration = $scope.p[i].hours;
           $scope.standardexplain = $scope.p[i].description;
         ...
         else if($scope.p[i].plan == 3)
         {
           $scope.premium = [];
           $scope.showpremium = 3;
           $scope.premiumprice = $scope.p[i].amount;
           $scope.premiumduration = $scope.p[i].hours;
           $scope.premiumexplain = $scope.p[i].description;
...
$scope.update = function ()
{
  ...
  angular.element('.preloader').show();
   var obj = { gigId:$scope.editdata.gigId,title:$scope.title,image:$scope.image,currencyId:$scope.currency,description:$scope.description,industryId:$scope.industry,servicesId:$scope.services,basic:$scope.basic,standard:$scope.standard,premium:$scope.premium,basicPrice:$scope.basicprice,premiumPrice:$scope.premiumprice,basicDuration:$scope.basicduration,basicExplain:$scope.basicexplain,standardPrice:$scope.standardprice,standardDuration:$scope.standardduration,standardExplain:$scope.standardexplain,premiumDuration:$scope.premiumduration,premiumExplain:$scope.premiumexplain,showbasic:$scope.showbasic,showpremium:$scope.showpremium,showstandard:$scope.showstandard};
  $http({
...
<?php } ?>
   ...
   <?php if(!empty($gigId))
        {  ?>
          ...
          $scope.get = function ()
          {
          var obj = {  page : $scope.page,gigId :<?php echo $gigId; ?>}
          ...
          var obj = { user_gig_buyId : $scope.gig.user_gig_buyId, user_gig_buyId : $scope.contractId,overall:$scope.rating,clientId:$scope.c,communication : $scope.communication,skill:$scope.skill,deadline:$scope.deadline,quality:$scope.quality,cooperation:$scope.cooperation,review:$scope.review,rehire:$scope.rehire,cost:$scope.cost,availability:$scope.availability,total:$scope.overall }
          angular.element(".preloader").show();
          $http({
        ...
        $scope.get();
         ...
         $scope.allowedgrace = '';
         $scope.data = [];
         $scope.errornumber = false;
         $scope.errorgrace = false;
            ...
            $scope.Update = function ($event)
            {
              ...
              if(parseInt($scope.taskinactivitystart) > parseInt($scope.taskinactivityend))
              {
                $scope.errornumber = true;
              ...
              if(parseInt($scope.taskinactivityend) < parseInt($scope.allowedgrace))
              {
                $scope.errorgrace = true;
                error = true;
              }
              else
              {
              ...
              $http({
                ...
                headers: {
                  ...
                  if(response.data.message == "true")
                 {
                   $.notify("Task Settings Updated Successfully", "success");
          ...
          //  edit invoice
           ...
           if(!empty($invoiceId))
                {
                  ?>
          var app81 = angular.module('myApp81',[])

          app81.directive('numbersOnly', function() {
            return {
              require: 'ngModel',
              link: function(scope, element, attrs, modelCtrl) {
                modelCtrl.$parsers.push(function(inputValue) {
        ...
        app81.directive('mydatepicker', function () {
          return {
            restrict: 'A',
            require: 'ngModel',
            link: function (scope, element, attrs, ngModelCtrl) {
        ...
        app81.directive('ngEnter', function () {
          return function (scope, element, attrs) {
            element.bind("keydown keypress", function (event) {
              if (event.which === 13) {
                scope.$apply(function () {
        ...
        app81.controller('myCtrt81', function($scope,$window,$http,$interval) {
      ...
      $scope.recurringclick = function()
      {
        ...
        if($scope.recurringType != '')
        {
           if($scope.duration == '')
           {
            ...
            var obj = { reference:$scope.reference,status:$scope.status,recipient:$scope.recipient,name:$scope.name,email:$scope.email,phone:$scope.phone,address:$scope.address,contractId:$scope.contract,task:$scope.task,amount:$scope.totalamount,discount:$scope.discount,discounttype:$scope.discounttype,tax:$scope.tax,payable:$scope.payable,currencyId:$scope.currency,taxAmount:$scope.taxAmount,discountAmount:$scope.discountAmount,paymentReceived:$scope.paymentReceived,status:$scope.status,recurring:$scope.recurringType,duration:$scope.duration,countryCode:$scope.countrycode,countryClass:cl,invoiceNo:$scope.invoiceno };
            angular.element('.preloader').show();
            $http({
              url: '<?php echo base_url(); ?>freelancer/invoicesave',
              method: "POST",
          ...
          $scope.getinvoice = function()
          {
            ...
            $http({
              ...
              if(response.data.message == "true")
              {
                ...
                $scope.status = $scope.invoice.status;
                $scope.paymentReceived = $scope.invoice.paymentReceived;
                if($scope.invoice.recurring)
                {
                  $scope.recurringType = $scope.invoice.recurring;
                  $scope.duration = $scope.invoice.duration;
                  $scope.showrecurring = 1;
                }
        ...
        <?php } ?>
          ...
          var app82 = angular.module('myApp82', [])

          app82.filter('date', function () {
          return function (item) {
          var dates = new Date(Date.parse(item))
          var newDate = '' + dates.getDate() + '-' + (dates.getMonth() + 1) + '-' + dates.getFullYear();
          return newDate;
          ...
          app82.filter('trustAsHtml',['$sce', function($sce) {
          ...
          app82.filter('htmlToPlaintext', function() {
          return function(text) {
          return  text ? String(text).replace(/<[^>]+>/gm, '') : '';
          };
          });
          ...
          app82.controller('myCtrt82', function($scope,$window,$http) {
          ...
          $scope.get = function()
          {
            var obj = { page :$scope.page };
            $http({
              url: '<?php echo base_url(); ?>freelancer/getassignContract',
              method: "POST",
              data:obj,
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
      ...
      ////////////assign contract detail

      <?php if(!empty($assigncontractjobId))
          {
            ?>

      var app83 = angular.module('myApp83', [])

      app83.filter('date', function () {
      return function (item) {
      var dates = new Date(Date.parse(item))
      var newDate = '' + dates.getDate() + '-' + (dates.getMonth() + 1) + '-' + dates.getFullYear();
      return newDate;
      ...
      app83.directive('mydatepicker1', function () {
        return {
          restrict: 'A',
          require: 'ngModel',
          link: function (scope, element, attrs, ngModelCtrl) {
      ...
      app83.directive('mydatepicker2', function () {
        return {
          restrict: 'A',
          require: 'ngModel',
          link: function (scope, element, attrs, ngModelCtrl) {
      ...
      app83.controller('myCtrt83', function($scope,$window,$http) {
      ...
      $scope.getteam = function()
   {
     $http({
      ...
      $scope.get = function()
      {
        var obj = { jobId :<?php echo $assigncontractjobId; ?> };
        $http({
          url: '<?php echo base_url(); ?>freelancer/getassignContractdetail',
          method: "POST",
          data:obj,
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
 ...
 $scope.taskChecked = function(mkey,key,$event)
    ...
    $scope.milestoneChecked = function($event)
    {
     ...
     $scope.changeclientStatus = function($event)
     {
      ...
      <?php } ?>
      // end assign contract detail

      // gig assign
      var app84 = angular.module('myApp84', [])


      app84.filter('trustAsHtml',['$sce', function($sce) {
   ...
   app84.controller('myCtrt84', function($scope,$window,$http,$interval) {
   ...
   $http({
    url: '<?php echo base_url(); ?>freelancer/getgigassign',
    method: "POST",
    data:obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
...
<?php if(!empty($gigassignId))
   {
     ?>
      // gig assign detail
      var app85 = angular.module('myApp85',['luegg.directives'])

      app85.filter('trustAsHtml',['$sce', function($sce) {
        ...
        app85.directive('mydatepicker2', function () {
          return {
            restrict: 'A',
            require: 'ngModel',
            link: function (scope, element, attrs, ngModelCtrl) {
              element.datepicker({
                ...
                onSelect: function (date) {
                  ...
                  var k = angular.element(element).attr('data-key');
                  var k1 = angular.element(element).attr('data-key1');
                 scope.gig.milestone[k].task[k1].dueDate = date;
                  scope.$apply();
                }
              });
            }
        ...
        app85.directive('mydatepicker1', function () {
          return {
            restrict: 'A',
            require: 'ngModel',
            link: function (scope, element, attrs, ngModelCtrl) {
              element.datepicker({
                ...
                onSelect: function (date) {
                  ...
                  var k = angular.element(element).attr('data-key');
                  var k1 = angular.element(element).attr('data-key1');
                  scope.gig.milestone[k].task[k1].startDate = date;
                  scope.$apply();
                }
              });
            }
        ...
        app85.filter('underscoreless', function () {
          return function (input) {
              if(input)
              {
              input = input.replace(/[^a-z0-9\s]/gi, '').replace(/[_\s]/g, ' ');
      ...
      app85.controller('myCtrt85', function($scope,$window,$http,$interval) {
      $scope.glued = true;
      $scope.gig = [];
      $scope.id ='';
      $scope.activity =[];
 ...
 $scope.taskChecked = function(mkey,key,$event)
    {
      if($event.target.checked ==  true)
      {
        $scope.gig.milestone[mkey].task[key].checked = 1;
        $scope.gig.milestone[mkey].checked = 1;
      }
      else
      {
        $scope.gig.milestone[mkey].task[key].checked = 0;
        $scope.gig.milestone[mkey].checked = 0;
      }
    ...
    $scope.milestoneChecked = function($event)
    {
      if($event.target.checked ==  true)
      {
        for(var i in $scope.gig.milestone)
        {
          for(var g in $scope.gig.milestone[i].task)
          {
           $scope.gig.milestone[i].task[g].checked = 1;
           }
         }
      }
      else
      {
        for(var i in $scope.gig.milestone)
        {
          for(var g in $scope.gig.milestone[i].task)
          {
           $scope.gig.milestone[i].task[g].checked = 0;
           }
         }
      }
    }
      ...
      $scope.get = function ()
      {
      var obj = {  id : '<?php echo $gigassignId; ?>'}

      $http({
      url: '<?php echo base_url(); ?>freelancer/getGigAssignDetail',
      method: "POST",
      data:obj,
      headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
      ...
      $scope.SaveMilestone = function()
    {
      ...
      var obj = {  project : $scope.gig.milestone };
      angular.element('.preloader').show();
   ...
   // dashboard
   var app86 = angular.module('myApp86',[])

   app86.filter('trustAsHtml',['$sce', function($sce) {
     ...
     app86.filter('underscoreless', function () {
       return function (input) {
           if(input)
           {
           return input.split(' ').join('-');
   ...
   app86.controller('myCtrt86', function($scope,$window,$http,$interval) {
   ...
   $scope.dsr = 0;
   $scope.hrstartdate = '';
   $scope.managerstartdate = '';
   $scope.mtotaltask = 0;
   $scope.mtotalproject =0;
   $scope.mdsr =0;
   $scope.mleave =0;
   $scope.mtotaltaskbyme = 0;
   $scope.mteam = 0;
   $scope.mproject = 0;
   $scope.emptotaltask = 0;
   $scope.empdsr = 0;
   $scope.empannouncement = 0;
   $scope.totalpl = 0;
   ...
   $scope.get = function()
 {
  ...
  $http({
    url: '<?php echo base_url(); ?>freelancer/getdashboarddata',
    method: "POST",
    data:obj,
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
    ...
    $scope.startdate = response.data.startdate;
    $scope.enddate = response.data.enddate;
    var expensegraph = response.data.expensegraph;
    var invoicegraph = response.data.invoicegraph;
    var incomegraph = response.data.incomegraph;
    var plgraph = response.data.plgraph;
    var expensegr = [];
    var invoicegr = [];
    var incomegr = [];
    var plgraphs = [];
    if(expensegraph)
    {
      for(var a in expensegraph)
      {
       expensegr.push(expensegraph[a]);
      }
    }

    if(plgraph)
    {
      for(var vv in plgraph)
      {
       plgraphs.push(plgraph[vv]);
      }
    }
    ...
    if(invoicegraph)
    {
      for(var a in invoicegraph)
      {
       invoicegr.push(invoicegraph[a]);
      }
    }
    if(incomegraph)
    {
      for(var a in incomegraph)
      {
       incomegr.push(incomegraph[a]);
      }
    }

    $scope.ajaxexpense(expensegr);
    $scope.ajaxinvoice(invoicegr);
    $scope.ajaxincome(incomegr);
    $scope.ajaxpl(plgraphs);

    if(response.data.expense.total)
    {
    $scope.expense = response.data.expense.total;
    }
    else
    {
      $scope.expense = 0;
    }
    if(response.data.invoice.total)
    {
    $scope.invoice = response.data.invoice.total;
    }
    else
    {
      $scope.invoice = 0;
    }
    if(response.data.income.total)
    {
    $scope.income = response.data.income.total;
    }
    else
    {
    $scope.income = 0;
    }
    if(response.data.totalpl)
    {
      $scope.totalpl = response.data.totalpl;
    }
    else
    {
    $scope.totalpl = 0;
...
{
   var obj = { startdate:$scope.hrstartdate }
 $http({
   url: '<?php echo base_url(); ?>freelancer/gethrdashboarddata',
   method: "POST",
   data:obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   ...
   $scope.hrstartdate = response.data.startdate;
   ...
   {
   $scope.interview = response.data.interview;
   }
   else
   {
     $scope.interview = 0;
   ...
   if(response.data.opening.total)
   {
   $scope.opening = response.data.opening.total;
   }
   else
   {
     $scope.opening = 0;
   }
   if(response.data.dsr)
   {
   $scope.dsr = response.data.dsr;
   }
   else
   {
     $scope.dsr = 0;
   ...
   $scope.ajaxemployee($scope.employee,$scope.hrstartdate);
   $scope.ajaxleave($scope.leave,$scope.hrstartdate);
   $scope.ajaxinterview($scope.interview,$scope.hrstartdate);
   $scope.ajaxopening($scope.opening,$scope.hrstartdate);
   $scope.ajaxdsr($scope.dsr,$scope.hrstartdate);
...
{
   var obj = { startdate:$scope.managerstartdate }
 $http({
   url: '<?php echo base_url(); ?>freelancer/getmanagerdashboarddata',
   method: "POST",
   data:obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   ...
   $scope.managerstartdate = response.data.startdate;
   if(response.data.totaltasktome)
   {
   $scope.mtotaltask = response.data.totaltasktome;
   }

   if(response.data.totaltaskbyme)
   {
   $scope.mtotaltaskbyme = response.data.totaltasktomebyme;
   }

   if(response.data.project)
   {
   $scope.mproject = response.data.project;
   }

   if(response.data.dsr)
   {
   $scope.mdsr = response.data.dsr;
   }

   if(response.data.leave)
   {
   $scope.mleave = response.data.leave;
   }

   if(response.data.team)
   {
   $scope.mteam = response.data.team;
   }

   $scope.ajaxtasktome($scope.mtotaltask,$scope.managerstartdate);
   $scope.ajaxtaskbyme($scope.mtotaltaskbyme,$scope.managerstartdate);
   $scope.ajaxproject($scope.mproject,$scope.managerstartdate);
   $scope.ajaxleaverequest($scope.mleave,$scope.managerstartdate);
   $scope.ajaxmyteam($scope.mteam,$scope.managerstartdate);
   $scope.ajaxdsr($scope.mdsr,$scope.managerstartdate);
...
$scope.getemployee = function ()
{
   var obj = { startdate:$scope.employeestartdate }
 $http({
   url: '<?php echo base_url(); ?>freelancer/getemployeedashboarddata',
   method: "POST",
   data:obj,
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   ...
   $scope.employeestartdate = response.data.startdate;
   if(response.data.totaltask)
   {
   $scope.emptotaltask = response.data.totaltask;
   }
   if(response.data.announcement)
   {
     $scpe.empannouncement = response.data.announcement;
   }
   if(response.data.dsr)
   {
     $scpe.empdsr = response.data.dsr;
   }

   $scope.ajaxemployeetask($scope.emptask,$scope.employeestartdate);
   $scope.ajaxdsr($scope.empdsr,$scope.employeestartdate);
   $scope.ajaxannouncment($scope.empannouncement,$scope.employeestartdate);

    });
}

  $scope.getdatewise = function ()
  {
    $scope.startdate = angular.element('.dashboardstartdate').val();
    $scope.enddate = angular.element('.dashboardenddate').val();
    $scope.get();
  }

  $scope.gethrdatewise = function()
  {
    $scope.hrstartdate = angular.element('.dashboardstartdate').val();
    $scope.gethr();
  }

$scope.getmanagerdatewise = function ()
{
  $scope.managerstartdate = angular.element('.dashboardstartdate').val();
  $scope.getmanager();
}

  $scope.getempdatewise = function()
  {
    $scope.employeestartdate = angular.element('.dashboardstartdate').val();
    $scope.getemployee();
  }

   $scope.ajaxexpense = function (data1)
  {
    // window.onload = function () {
  ...
  $("#chartContainerexpense").CanvasJSChart(options);
  }

  $scope.ajaxpl = function (data1)
 {
   // window.onload = function () {
 ...
 $("#chartContainerpl").CanvasJSChart(options);
 }

  $scope.ajaxinvoice = function (data1)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainerinvoice").CanvasJSChart(options);

 }

 $scope.ajaxincome = function (data1)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainerincome").CanvasJSChart(options);

 }

 $scope.ajaxemployee = function (emp,date)
 {
   var options = {
    animationEnabled: true,
    title: {
    ...
    data: [{
      type: "column",
      yValueFormatString: "#,##0.0#"%"",
      dataPoints:[{ label:date, y:emp },	]
    }]
   };
   $("#chartContaineremployee").CanvasJSChart(options);
 }

 $scope.ajaxleave = function (leave,date)
 {
   var options = {
    animationEnabled: true,
    title: {
    ...
    data: [{
      type: "column",
      yValueFormatString: "#,##0.0#"%"",
      dataPoints:[{ label:date, y:leave },	]
    }]
   };
   $("#chartContainerleave").CanvasJSChart(options);
 }

 $scope.ajaxinterview = function (interview,date)
 {
   var options = {
    animationEnabled: true,
    title: {
    ...
    data: [{
      type: "column",
      yValueFormatString: "#,##0.0#"%"",
      dataPoints:[{ label:date, y:interview },	]
    }]
   };
   $("#chartContainerinterview").CanvasJSChart(options);

 }

 $scope.ajaxopening = function(val,date)
 {
  var val = Number(val);
   var options = {
    animationEnabled: true,
    ...
    data: [{
      type: "column",
      yValueFormatString: "#,##0.0#"%"",
      dataPoints:[{ label:date, y:val },]
    }]
   };
   $("#chartContaineropening").CanvasJSChart(options);

 }

 $scope.ajaxdsr = function(dsr,date)
 {
   var options = {
    animationEnabled: true,
    title: {
    ...
    data: [{
      type: "column",
      yValueFormatString: "#,##0.0#"%"",
      dataPoints:[{ label:date, y:dsr },	]
    }]
   };
   $("#chartContainerdsr").CanvasJSChart(options);
 }


  $scope.ajaxannouncment = function(dsr,date)
  {
    var options = {
     animationEnabled: true,
     title: {
    ...
    $("#chartContainerannouncment").CanvasJSChart(options);
  }

 $scope.ajaxtasktome = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainertotaltasktome").CanvasJSChart(options);
 }

 $scope.ajaxtaskbyme = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainertotaltaskbyme").CanvasJSChart(options);
 }

 $scope.ajaxemployeetask = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContaineremptask").CanvasJSChart(options);
 }

 $scope.ajaxproject = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainerproject").CanvasJSChart(options);
 }

 $scope.ajaxleaverequest = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainerleaverequest").CanvasJSChart(options);
 }

 $scope.ajaxmyteam = function(val,date)
 {
   var options = {
    animationEnabled: true,
    title: {
   ...
   $("#chartContainermyteam").CanvasJSChart(options);
 }
 ...
 $scope.clicktab = function(id)
 {
  if(id == 1)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.expensegrpah').show();
  }
  else if(id == 2)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.invoicegrpah').show();
  }
  else if(id == 3)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.incomegrpah').show();
  }
  else if(id == 7)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.plgrpah').show();
  }
 }

 $scope.clicktabhr = function(id)
 {
  if(id == 1)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.employeegrpah').show();
  }
  else if(id == 2)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.leavegrpah').show();
  }
  else if(id == 3)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.interviewgrpah').show();
  }
  else if(id == 4)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.openinggrpah').show();
  }
  else if(id == 5)
  {
    angular.element('.dashboard-grap').hide();
    angular.element('.dsrgraph').show();
  }
 }

 $scope.managerclicktab = function(id)
 {
   if(id == 1)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.totaltasktome').show();
   }
   else if(id == 2)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.totaltaskbyme').show();
   }
   else if(id == 3)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.dsrgrpah').show();
   }
   else if(id == 4)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.projectgrpah').show();
   }
   else if(id == 5)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.leavereqgrpah').show();
   }
   else if(id == 6)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.myteamgraph').show();
   }
 }

 $scope.empclicktab = function(id)
 {
   if(id == 1)
   {
     angular.element('.dashboard-grap').hide();
   ...
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.totaldsr').show();
   }
   else if(id == 3)
   {
     angular.element('.dashboard-grap').hide();
     angular.element('.totalannouncment').show();
   }
 }
   ...
   // profit loss detail
   // project profit loss
   <?php if(!empty($profitprojectId))
        {
          ?>
   var app87 = angular.module('myApp87',[])

   app87.directive('numbersOnly', function() {
     return {
       require: 'ngModel',
       link: function(scope, element, attrs, modelCtrl) {
         modelCtrl.$parsers.push(function(inputValue) {
   ...
   app87.controller('myCtrt87', function($scope,$window,$http,$interval) {
     ...
     $scope.gettask = function()
     {
       var obj = {  page : $scope.page,projectId:<?php echo $profitprojectId; ?> }
       $http({
         url: '<?php echo base_url(); ?>freelancer/getroi_project',
         method: "POST",
         data:obj,
     ...
     {
       var obj = {  projectId:<?php echo $profitprojectId; ?> }
       $http({
         url: '<?php echo base_url(); ?>freelancer/getproject_edit',
         method: "POST",
         data:obj,
...
<?php } ?>
   ...
   // team add
   var app88 = angular.module('myApp88',['ngImgCrop'])

   app88.directive('mydatepicker', function () {
   return {
   restrict: 'A',
   require: 'ngModel',
   link: function (scope, element, attrs, ngModelCtrl) {
   ...
   app88.directive('numbersOnly', function() {
   return {
   require: 'ngModel',
   link: function(scope, element, attrs, modelCtrl) {
     modelCtrl.$parsers.push(function(inputValue) {
   ...
   app88.controller('myCtrt88', function($scope,$window,$http,$interval) {
   $scope.teams =[];
   $scope.services =[];
   $scope.allproject = [];
   $scope.years =[];
   ...
   {
     $scope.salary = $event.value;
    if($scope.working.workingDays && $scope.working.workingHour )
    {
     var  hours = 0;
     var  minutes = 0;
     $scope.perday = parseInt(+$scope.salary / +$scope.working.workingDays);
   ...
   {
   $http({
   url: '<?php echo base_url(); ?>freelancer/getcompanyinfo',
   method: "POST",
   headers: {
     'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
   }
   }).then(function(response)
   {
      ...
      var working = response.data.working;
      if(service.length == 0 || department.length == 0 || !working )
      {
        angular.element('#companyinfoupdate').modal('show');
      }
   ...
   angular.element(".preloader").show();
   // ,status : $scope.status
   var obj = {  name  : $scope.name , desig  : $scope.designation,logo: $scope.image , maxPrice : $scope.perhour ,rep_ph_num : $scope.phone, address1  : $scope.address,services : $scope.skill, access :$scope.access ,email : $scope.email,project :$scope.project,salary:$scope.salary,perday:$scope.perday,perHour:$scope.perhour,skype:$scope.skype,countryCode:$scope.countrycode,countryClass:cl,salaryCurrencyId:$scope.currency,department:$scope.department,joiningdate:$scope.joiningdate };
   ...
   $http({
     ...
     if(response.data.success == "1")
     {
       ...
       $interval(callAtInterval, 2500);
        function callAtInterval()
        {
         $window.location.href = '<?php echo base_url(); ?>team/<?php echo $this->session->userdata['clientloggedin']['url']; ?>';
        }
       $scope.team();
       $scope.submitteam = false;
     ...
     {
       $.notify("Email Address already Registered", "error");
     }
   ...
   if($scope.phone1 == '' || $scope.address1 == '' || $scope.skype1 == '' || $scope.salary1 == '' || $scope.perday1 == '' || $scope.currency1 == '' || $scope.department1 =='' || $scope.joiningdate1 == '' || $scope.about1 == '')
   {
     error = true;
   }
...
else
{
  ...
  $scope.$apply();
   ...
   // team edit
   <?php if(!empty($teammemberId))
   {
     ?>
   var app89 = angular.module('myApp89',['ngImgCrop'])

   app89.directive('mydatepicker', function () {
   return {
     restrict: 'A',
     require: 'ngModel',
     link: function (scope, element, attrs, ngModelCtrl) {
   ...
   app89.directive('mydatepicker1', function () {
   return {
     restrict: 'A',
     require: 'ngModel',
     link: function (scope, element, attrs, ngModelCtrl) {
       element.datepicker({
         ...
         onSelect: function (date) {
           scope.date = date;
           scope.profile.joiningdate = date;
           scope.$apply();
         }
       });
     }
   ...
   app89.controller('myCtrt89', function($scope,$window,$http,$interval) {
   $scope.profile = [];
   $scope.experience =[];
   $scope.activity ='';
   $scope.other ='';
...
$scope.salaryCount1 = function()
{
   var  hours = 0;
   var  minutes = 0;
$scope.profile.perday = parseInt($scope.profile.salary / $scope.working.workingDays) ;
 var a = $scope.working.workingHour.split(":");
var hours = a[0] * 60;
var minutes = a[1];
if(hours || minutes)
...
$scope.profile.perHour = parseInt($scope.profile.perday / totalhours) ;
   ...
   $scope.getuserprofile = function ()
   {
     var obj = {  id :'<?php echo $teammemberId; ?>'   }
   ...
   var phone = angular.element('#phone').val();
   $scope.profile.dateofbirth = angular.element('#dateofbirth').val();
   $scope.profile.joiningdate = angular.element('#joiningdate1').val();
   $scope.profile.marriageAnniversary = angular.element('#marriageAnniversary').val();
   $scope.profile.about = CKEDITOR.instances['about'].getData();
   var pclass = $('#phone').attr('class');
   $scope.countrycode = $('.iti__selected-flag').attr('title');
   ...
   if($scope.profile.name =='' || $scope.profile.desig == "" || $scope.profile.rep_ph_num == '' || $scope.profile.address == "" || $scope.profile.about == '' || $scope.services.lenth == 0 || $scope.profile.dateofbirth == '' ||  !$scope.profile.maritalStatus || $scope.profile.logo == '' || $scope.profile.address1 == '' || !$scope.profile.currencyId || $scope.profile.maxPrice == '')
   {
     error = true;
   }
   if($scope.profile.salary == '' || $scope.profile.perday == '' || $scope.profile.perHour == '' || $scope.profile.department == '' || $scope.profile.access == '' || $scope.profile.joiningdate == '' || $scope.profile.skype == '')
   {
     error = true;
   }

   if($scope.profile.maxPrice == 0)
   {
     error = true;
   }
   ...
   var m = JSON.stringify({ u_id:$scope.profile.u_id,name  : $scope.profile.name,logo :$scope.profile.logo,desig: $scope.profile.desig ,rep_ph_num  : $scope.profile.rep_ph_num ,address1 : $scope.profile.address1,about : $scope.profile.about,experience:$scope.experience,services:$scope.services,activityType:$scope.other,activity : $scope.activity,countryCode:$scope.countrycode,countryClass:cl,dateofbirth:$scope.profile.dateofbirth,maritalStatus:$scope.profile.maritalStatus,marriageAnniversary:$scope.profile.marriageAnniversary,activities:$scope.activities,currencyId:$scope.profile.currencyId ,maxPrice:$scope.profile.maxPrice,salary:$scope.profile.salary,perday:$scope.profile.perday,perHour:$scope.profile.perHour,department:$scope.profile.department,access:$scope.profile.access,skype:$scope.profile.skype,joiningdate:$scope.profile.joiningdate});
   angular.element(".preloader").show();
   $http({
     url: '<?php echo base_url(); ?>freelancer/updateteam',
     method: "POST",
     ...
     if(response.data.message == "true")
     {
       ...
       $interval(callAtInterval, 2000);
          function callAtInterval()
          {
            $window.location.href = '<?php echo base_url(); ?>team/<?php echo $this->session->userdata['clientloggedin']['url']; ?>/<?php echo $this->session->userdata['clientloggedin']['aurl']; ?>';
          }
     }
