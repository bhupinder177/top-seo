...
include('sidebar.php');
?>
<div id="wrapper" ng-cloak class="content-wrapper" ng-app="myApp91" ng-controller="myCtrt91">
      ...
      <div class="no-border-radius">
          ...
          <div class="main-wrapper px-3">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="review-period">
                  <label>Project <span class="red-text">*</span></label>
                </div>
              </div>
              <div class="col-md-8">
                <div class="review-input">
                  <div class="form-group">
                    <input ng-disabled="status == 1" placeholder="Please enter project"  ng-model="project" ng-value="project" name="text" class="form-control">
  ...
  <div class="main-wrapper px-3">
    <div class="row">
      ...
      <div class="col-md-2">
        <div class="review-period">
          <label>Comment <span class="red-text">*</span></label>
        </div>
      </div>
      <div class="col-md-10">
        <div class="review-input">
          <div class="form-group">
            <textarea ng-disabled="status == 1" placeholder="Please enter comment" ng-model="review" ng-value="review"  name="text" class="form-control"></textarea>
            <p ng-show="forms && !review" class="text-danger">Please enter comment.</p>
          ...
          <div class="performanceratingtable">
            <div  ng-repeat="(key,x) in form">
              ...
              <div class="criteriaComment">
                  <label>Comment</label>
                  <textarea ng-disabled="status == 1"  ng-model="x2.comment" ng-value="x2.comment" class="form-control"></textarea>
