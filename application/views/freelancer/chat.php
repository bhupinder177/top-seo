                  ...
                  <div class="">
                    ...
                    <div class="col-md-12 text-right"><a  class="btn btn-primary bg-orange my-3"  data-toggle="modal" data-target="#groupcreate">New Chat</a></div>
                          ...
                          <li ng-if="group.length != 0 " ng-repeat="(key,x) in group" ng-click="selectgroup(x._id,key)"  ng-class="{ 'active' : x._id == roomId }"  class="left clearfix" >
                            <div class="chat-body clearfix">
                              ...
                              <div class="header_sec">
                                ...
                                <a ng-if="x.Type == 0" ng-class="{ 'customiconChat' : x.UserId != userId && x.Type == 0 }" class="btn btn-user" ng-click="addmembers(x._id,x.UserId)"> <i  class="fa fa-user-plus"></i></a>
                      ...
                      <div  class="col-sm-12 col-lg-8">
                        <div class="row" >
                          <div ng-if="group[groupkey].Name" class="col-md-12"><h4 class="chat_hed"><b>{{ group[groupkey].Name }}</b></h4></div>
                          <!--new_message_head-->
