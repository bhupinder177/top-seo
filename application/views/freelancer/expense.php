...
<div id="wrapper" class="content-wrapper">
  ...
  <section class="content portfolio-cont expence-cstm freelancer-cstm">
      ...
      <div ng-cloak  ng-app="myApp24" ng-controller="myCtrt24">
        <div id="content">
          <div class="no-border-radius">
            <div class="row">
                    <div class="col-md-12">
                <div class="bg-white box-header with-border py-3">
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-2">
			   ...
			   <div class="col-md-2">
			     <div class="form-group">
					 <select ng-model="optionvalue" onchange="angular.element(this).scope().changeoption(this)" class="form-control" >
             <option value="">Select option</option>
              <option value="1">Add Expense</option>
					   <option value="2">Clone</option>
					   <option value="3">Export Excel</option>
					 </select>
                 </div>
               ...
               <div class="col-md-12">
                 <div class="row  form-group mb-0">
                    ...
                    <div class="col-md-2">
						<h3 ng-click="clickadvanceSearch()">Advance search</h3>
					</div>
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="position" class="m-0">Remarks</label>
                              <textarea  placeholder="Please enter remarks" class="form-control" ng-model="remarks" ng-value="remarks"  id="remarks"></textarea>
                            </div>
                            ...
                            <div class="form-group ">
                              <label for="name" class="m-0">Upload</label>
                              <input type="file" onchange="angular.element(this).scope().Attachment(this)" id="upload" class="form-control" name="upload" >
                              <a target="_blank" ng-if="file != ''" href="<?php echo base_url(); ?>assets/expenseupload/{{ file }}">{{ file }}</a>
                            ...
                            <input type="checkbox" class="expenserecurring" value="0" ng-model="recurring"  id="status"  />
                            </div>
                  ...
                  <div ng-cloak ng-if="show == 0" class="box-body action-cstm bg-white mt-3">
                    ...
                    <table   id="rankingTable" class="table">
                      <thead>
                        ...
                        <th class="text-center">Amount <span ng-if="getuserlocalcurrency.code">({{ getuserlocalcurrency.code }} {{ getuserlocalcurrency.symbol }})</span></th>
                      ...
                      <tbody>
                        <tr ng-if="currentEx.length != 0 && loader == 1" ng-repeat="(key,x) in currentEx" >
                          ...
                          <td><a target="_blank" ng-if="x.file != ''" href="<?php echo base_url(); ?>assets/expenseupload/{{ x.file }}">{{ x.file }}</a></td>

                          <td>
                            <span class="btn" style="background: #3a3adf;color:#fff;padding: 5px; border-radius: 4px;" ng-if="x.status == 1 && x.deleted == 0">Paid</span>
                            <span class="btn" style="background: #ff0000;color:#fff;padding: 5px; border-radius: 4px;" ng-if="x.status == 2 && x.deleted == 0">Unpaid</span>
                            <span class="btn" style="background: #ff0000;color:#fff;padding: 5px; border-radius: 4px;" ng-if="x.status == 1 && x.deleted == 1">Deleted</span>
                            <span class="btn" style="background: #ff0000;color:#fff;padding: 5px; border-radius: 4px;" ng-if="x.status == 2 && x.deleted == 1">Deleted</span>
                          </td>
                            <td>
                                <div ng-if="x.deleted == 0" class="dropdown ac-cstm text-right">
                                 <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url(); ?>assets/dashboard/images/dots-img.png" class="pro-img">
                                 </a>
                                 <div class="dropdown-menu fadeIn">
                                     <a ng-if="x.deleted == 0" class="dropdown-item" title="Edit Expense" ng-click="edit(x.id)"><i class="fa fa-edit"></i> Edit</a>
                                     <a ng-if="x.deleted == 0" class="dropdown-item" ng-click="confirm(x.id)"><i class="fa fa-trash"></i>Delete</a>
                      ...
                      <div >
                           ...
                           <h4 ng-if="currentTotal != 0"  class="p-3 text-right w-100">Total Expense: {{ currentEx[0].code }} {{ currentEx[0].symbol }} {{ currentTotal  }} </h4>
                           <h4 ng-if="totalpaid != 0" class="p-3 text-right w-100"> Total Paid Amount: {{ currentEx[0].code }} {{ currentEx[0].symbol }} {{ totalpaid  }} </h4>
                           <h4 ng-if="totalunpaid != 0"  class="p-3 text-right w-100">Total Unpaid Amount: {{ currentEx[0].code }} {{ currentEx[0].symbol }} {{ totalunpaid  }} </h4>
                      </div>
                    </div>
          ...
          <div ng-cloak class="box-body action-cstm bg-white mt-3">
            ...
            <table   id="rankingTable" class="table">
              ...
              <tbody>
                <tr ng-if="currentEx.length != 0 && loader == 1"  ng-repeat="(key,x) in monthEx" >
                  <td>{{ x.expense }}</td>
                  <td>{{ x.remarks | limitTo:50 }}</td>
                  <td>{{ x.date | date }}</td>
                  <td class="text-center">{{ x.amount  }}</td>
            ...
            <div ng-if="monthtotal != 0">
                 <h4 ng-if="monthtotal && monthtotal != 0"  class="p-3 text-right w-100">Total Expense: {{ monthEx[0].code }} {{ currentEx[0].symbol }} {{ monthtotal }} </h4>
                 <h4 ng-if="monthtotalpaid && monthtotalpaid != 0" class="p-3 text-right w-100">Total Paid Amount: {{ monthEx[0].code }} {{ currentEx[0].symbol }} {{ monthtotalpaid  }} </h4>
                 <h4 ng-if="monthtotalunpaid && monthtotalunpaid != 0"  class="p-3 text-right w-100">Total Unpaid Amount: {{ monthEx[0].code }} {{ currentEx[0].symbol }} {{ monthtotalunpaid  }}  </h4>
            </div>
            </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="position" class="m-0">Remarks</label>
              <textarea  placeholder="Please enter remarks" class="form-control" ng-model="remarks1" ng-value="remarks1"  id="remarks"></textarea>
            </div>

            <div class="form-group">
              <label for="position" class="m-0">Recurring Expense </label>
            <input type="checkbox" class="expenserecurring" value="0" ng-checked="recurring1 == 1" value="1" ng-model="recurring1"  id="status"  />
            </div>
            <div class="form-group ">
              <label for="name" class="m-0">Upload</label>
              <input type="file" onchange="angular.element(this).scope().Attachment1(this)" id="upload1" class="form-control" name="upload" >
              <a target="_blank" ng-if="editfile != ''" href="<?php echo base_url(); ?>assets/expenseupload/{{ editfile }}">{{ editfile }}</a>
            </div>
          </div>
          <div class="modal-footer">
