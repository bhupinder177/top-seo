                ...
                <div class="c-pass-sec bg-white">
                    ...
                    <div class="col-md-6">
                      <div class="scheduling-work">
                        <div class="row">
                          <a  hand="" id="plusicon" class="d-block ng-scope">Add Break <i ng-click="breakadd(key)" class="fa fa-fw fa-plus-square"></i></a>
                      ...
                      <div class="form-group row">
                          <div class="col-md-12">
                         <input  placeholder="00:00"  ng-model="breakfasthr" ng-value="breakfasthr" type="text" class="form-control hrs ">
                         <p ng-show="submitb && breakfasthr != '' && breakfasrerror == 1 " class="text-danger">Please enter valid time format.</p>
                     ...
                     <div class="form">
                      ...
                      <div class="form-group row">
                          <div class="col-md-12">
                        <input  placeholder="00:00" ng-model="lunchhr" ng-value="lunchhr" type="text" class="form-control hrs">
                        <p ng-show="submitb && lunchhr != '' && luncherror == 1 " class="text-danger">Please enter valid time format.</p>
                      ...
                      <div class="form-group row">
                          <div class="col-md-12">
                        <input  placeholder="00:00" ng-model="teahr" ng-value="teahr" type="text" class="form-control hrs">
                        <p ng-show="submitb && teahr != '' && teaerror == 1 " class="text-danger">Please enter valid time format.</p>
                      ...
                      <div class="form-group row">
                          <div class="col-md-12">
                         <input  placeholder="00:00" ng-model="dinnerhr" ng-value="dinnerhr" type="text" class="form-control hrs">
                         <p ng-show="submitb && dinnerhr != '' && dinnererror == 1 " class="text-danger">Please enter valid time format.</p>
