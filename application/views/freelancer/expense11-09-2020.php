                ...
                <div class="col-md-2">
                 <div class="form-group sea-cstm">
                   <input  ng-click="searchdate()" type="button" value="Search" class="btn btn-success w-100 mb-0" >
						  ...
						  <div class="col-md-1">
				  <div class="form-group sea-cstm">
				 <a class="advancesearch btn btn-cstm active-icon"  ng-click="clickadvanceSearch()"><i class="fa fa-angle-double-down"></i></a>
			 </div>
			 </div>
               </div>
               </div>
                        ...
                        <div class="form-group sea-cstm">
                          <input  ng-click="getMonthExpense()" type="button" value="Search" class="btn btn-success w-100" >
                              ...
                              <div class="col-md-2">
					              ...
					              <div  class="col-md-2">
                                 <a  data-toggle="modal" ng-click="addexpense()" class="btn btn-success mb-0">Add Expense</a>
                              </div>
