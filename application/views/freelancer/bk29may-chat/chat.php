					...
					<div class="container-fluid">
						...
						<div class="content-box no-border-radius">
							...
							<div class="profile-preview profile-container">
								...
								<div ng-app="myApp1" ng-controller="myCtrt1" id="chatcontroller" class="container">
...
<!-- scroll-glue-bottom="glued" schroll-bottom="messages" -->
																...
																<li   ng-repeat="(key,x) in messages[roomId]"   class="left clearfix admin_chat">
																	...
																	<div class="chat-body1 clearfix">
																		...
																		<div ng-class="{ 'pull-right sender-right' : userId == x.MSG_SENTBY ,'pull-left sender-left' : userId != x.MSG_SENTBY }" >
																			...
																			<p ng-show="x.MSG_DELETE == 0" ><span class="editmsg{{ x._id }} msg{{ x._id}}"  ng-bind-html="x.MSG_TEXT|trustAsHtml"></span>
	                                      ...
	                                      <!-- <a ng-if="x.offer != '0'" href="<?php echo base_url(); ?>freelancer/job/{{ x.offer }}" >View detail</a>-->
																				...
																				<span  ng-if="x.MSG_ATTACHMENT && x.MSG_ATTACHMENT != ''" class="attachement">
																					...
																					<p ng-if="x.MSG_DELETE == 1">Message has been deleted</p>
																					 ...
																					 <button ng-click="messageUpdate('update',x._id)" ng-if="editmsgId == x._id && edit == 1">Save</button>
																					 <button ng-click="messageUpdate('cancel',x._id)" ng-if="editmsgId == x._id && edit == 1">Cancel</button>
																					...
																					<div ng-class="{ 'pull-left' : userId == x.senderId ,'pull-right' : userId != x.senderId }" class="chat_time">{{ x.createdAt | time }}</div>
																				</div>
																	...
																	<div ng-show="messages[0]['receiverId'] != userId || person[selectedContact]['status'] == 1 "   class="message_write">
																		...
																		<textarea ng-keyup="updateTyping()" ng-model="msg" ng-show="person[selectedContact]['cid'] != userId" ng-enter="sendmessage(person[selectedContact]['cid'],person[selectedContact]['friendId'])"  name="msgtext" class="msgtext form-control fr" placeholder="type a message"></textarea>
																		...
																		<div class="chat_bottom">
																			...
																			<!-- <button  ng-show="person[selectedContact]['fid'] != userId" ng-click="sendmessage(person[selectedContact]['fid'],person[selectedContact]['friendId'])" scroll-bottom="bottom" class="pull-right btn btn-success msgfree" ng-disabled="person[selectedContact]['status'] == 0  || person[selectedContact]['status'] == 2 ">
																				Send</button> -->
																			<button  ng-show="person[selectedContact]['cid'] != userId" ng-click="sendmessage(person[selectedContact]['cid'],person[selectedContact]['cname'],person[selectedContact]['friendId'])" scroll-bottom="bottom" class="pull-right btn btn-success msg" ng-disabled="person[selectedContact]['status'] == 0  || person[selectedContact]['status'] == 2 ">
																					Send</button>
																				</div>
																			</div>
