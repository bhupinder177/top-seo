                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control rounded-0 gigtitle" ng-model="title" id="title" placeholder="Please enter gig title"  />
                           ...
                           <div class="col-lg-6 col-md-12">
                              <div class="form-group">
                                 ...
                                 <p ng-cloak ng-show="allindustry.length == 0 " class="text-danger"><a class="text-danger" target="_blank" href="<?php echo base_url(); ?>freelancer/services">Data is incomplete. Please click here to complete the information.</a></p>
                              </div>
                           </div>
                           <div class="col-lg-6 col-md-12">
                              <div class="form-group">
                                 ...
                                 <p ng-cloak ng-show="allservices.length == 0 " class="text-danger"><a class="text-danger" target="_blank" href="<?php echo base_url(); ?>freelancer/services">Data is incomplete. Please click here to complete the information.</a></p>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-5">
                                     <div class="form-group">
                                        ...
                                        <select onchange="angular.element(this).scope().planchange(this)" ng-model="x.plan"  class="form-control">
                                          <option value="">Select Plan</option>
                                          <!-- <option value="1">Basic</option>
                                          <option value="2">Standard</option>
                                          <option value="3">Premium</option> -->
                                          <option ng-repeat="(key,x2) in showplans" value="{{ x2.id }}" ng-if="plans[key - 1].plan != x2.id">{{ x2.plan }}</option>
                                        </select>
