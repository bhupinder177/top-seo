               ...
               <div class="social-links-area p-3 bg-white">
                  ...
                  <div class="top-rated-emp-container">
                        <div class="row">
                           ...
                           <div class="col-lg-6 col-md-12">
                              <div class="form-group ">
                                 <label for="name" class="m-0">Gig Images<span class="text-danger">*</span></label>
                                 <input accept="image/*"/ multiple onchange="angular.element(this).scope().imageupload(this)" type="file" id="file" class="form-control" name="file">
                                 <div class="col-lg-12">
                                 ...
                                 <p ng-cloak ng-show="submitr && image == '' &&  !profileimageerror" class="text-danger">Please select image.</p>
		        ...
		        <li>
              <input type="checkbox" ng-click="selectedplan($event,'1')" name="basic">
		        <a ng-class="{ 'disabled' : 0 == showbasic }"  data-toggle="tab" class="active show" href="#basic">Basic</a>
		        </li>
						<li>
              <input type="checkbox" ng-click="selectedplan($event,'2')" name="basic">

					 <a ng-class="{'disabled': 0 == showstandard}" data-toggle="tab" href="#standard" class="">Standard</a>
					 </li>
					 <li>
             <input type="checkbox" ng-click="selectedplan($event,'3')" name="basic">
