...
$scope.profile.rep_ph_num = angular.element("#phone").val();
...
// $scope.address == '' ||
if($scope.phone == '' || $scope.skype == '' || $scope.salary == '' ||  $scope.currency == '' || $scope.department == '' || $scope.joiningdate == '')
{
  error = true;
...
$scope.phone = angular.element('#phone').val();
$scope.address = angular.element('#address').val();
$scope.dateofbirth = angular.element('#dateofbirth').val();
$scope.maritalStatus = angular.element('#maritalStatus').val();
$scope.marriageAnniversary = angular.element('#marriageAnniversary').val();
...
if($scope.maritalStatus == 2)
{
  if($scope.marriageAnniversary == '')
  {
    error =true;
  }
}
if($scope.name =='' || $scope.designation == "" || $scope.phone == '' || $scope.address == "" || $scope.about == '' || $scope.services.lenth == 0 || $scope.dateofbirth =='' ||  $scope.maritalStatus == '')
{
  error = true;
}
...
var m = JSON.stringify({ name  : $scope.name,logo :$scope.image,desig: $scope.designation ,rep_ph_num  : $scope.phone ,address1 : $scope.address,about : $scope.about,experience:$scope.experience,services:$scope.services,activityType:$scope.other,activity : $scope.activity,countryCode:$scope.countrycode,countryClass:cl,dateofbirth:$scope.dateofbirth,maritalStatus:$scope.maritalStatus,marriageAnniversary:$scope.marriageAnniversary });
angular.element(".preloader").show();
$http({
...
if($scope.expense == '' ||  $scope.amount == '' || $scope.currency == '' )
{
  error = true;
}
...
angular.element(".preloader").show();
var obj = {  expense :$scope.expense,amount:$scope.amount,paidby:$scope.paidby,status:$scope.status,currencyId:$scope.currency,recurring:$scope.recurring };
...
if($scope.expense1 == '' ||  $scope.amount1 == '' || $scope.date1 == '' || $scope.paidby1 =='' || $scope.status1 == '' || $scope.currency1 =='' )
{
  error = true;
}
...
$scope.addholiday = function()
{
  ...
  $scope.saveworking = function()
  {
    ...
    $http({
      ...
      if(response.data.message == "true")
      {
        $.notify("Working Days Added Successfully", "success");
      }
      else if(response.data.message == "false")
      {
...
<?php if(isset($projectId))
{
    ...
    if(!empty($taskId))
    {
      ...
      app41.controller('myCtrt41', function($scope,$window,$http,$interval) {
        ...
        $scope.statusUpdate = function()
        {
          ...
          $http({
            ...
            if(response.data.message == "true")
            {
              $.notify("Leave Status Updated Successfully", "success");
              $scope.getleave();
      ...
      app43.controller('myCtrt43', function($scope,$window,$http,$interval) {
        ...
        $scope.submitleavetype = function()
        {
          ...
          if($scope.title == '' && $scope.duration =='' && $scope.durationType == '')
          ...
          var obj = { type:$scope.title,duration:$scope.duration,durationType:$scope.durationType };
          angular.element('.preloader').show();
          $http({
            ...
            if(response.data.message == "true")
            {
              ...
              $.notify("Leave Type Added Successfully", "success");
        ...
        $scope.updateleavetype = function()
        {
          ...
          if($scope.title1 == '' && $scope.duration1 =='' && $scope.durationType1 == '')
          {
            error = true;
          }
          if(error == true)
          ...
          var obj = { id:$scope.editleave1.id , type:$scope.title1,duration:$scope.duration1,durationType:$scope.durationType1 };
          ...
          $http({
            ...
            if(response.data.message == "true")
            {
              ...
              $.notify("Leave Type Successfully", "success");
  ...
  app45.controller('myCtrt45', function($scope,$window,$http,$interval) {
    ...
    $scope.submittodo = function()
    {
      ...
      $scope.date = angular.element('#date').val();
      // $scope.file == ''
      if($scope.name == '' || $scope.priority == '' || $scope.department == '' || $scope.team == '' || $scope.description == ''  || $scope.date == '' )
      {
        error = true;
      }
      ...
      var obj = { name:$scope.name,date:$scope.date,priority:$scope.priority,dept:$scope.department,assignedTo:$scope.team,status:'2',description:$scope.description,file:$scope.file };
      angular.element('.preloader').show();
      $http({
    ...
    {
      var obj = { page :$scope.page,status:$scope.sstatus,priority:$scope.spriority };
      $http({
    ...
    $scope.edittodo = function(id)
    {
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.date1 = $scope.edittodo1.date;
    ...
    $scope.updatetodo = function()
    {
      ...
      if($scope.name1 == '' || $scope.priority1 == '' || $scope.department1 == '' || $scope.team1 == '' || $scope.description1 == '' || $scope.status1 == '' || $scope.date1 == '' )
      {
        error = true;
      }
      ...
      var obj = {id:$scope.edittodo1.id, name:$scope.name1,date:$scope.date1,priority:$scope.priority1,dept:$scope.department1,assignedTo:$scope.team1,status:$scope.status1,description:$scope.description1,file:$scope.file };
      angular.element('.preloader').show();
      $http({
    ...
    $scope.startTime = function(key,taskId)
    {
      var obj = {  todoId : taskId,type:1 }
      $http({
        url: '<?php echo base_url(); ?>freelancer/tasktimeStart',
        method: "POST",
        data:obj,
        ...
        if(response.data.message == "true")
        {
          $scope.taskstartkey = key;
          $scope.taskstartId = taskId;

            $scope.alltodo[key].timer = 1;
          for(var a in $scope.alltodo)
          {
            ...
            $scope.alltodo[key].disable = 1;
            $scope.alltodo[key].showbutton = 2;
            $scope.totalSeconds = 0;
            setTime();
           $.notify("Timer Start Successfully", "success");
        }
    ...
    $scope.stoptimer = function(key,taskId)
    {
      var obj = {  todoId : taskId,type:1 }
      $http({
        url: '<?php echo base_url(); ?>freelancer/todotaskStop',
...
app53.controller('myCtrt53', function($scope,$window,$http,$interval) {
 ...
 $http({
  ...
  $scope.submitincome = function()
  {
    ...
    // $scope.project == '' ||
    // $scope.milestone == ''
    if($scope.client == '' || $scope.project == '' ||  $scope.amount == '' || $scope.currency == '' ||  $scope.date == '' || $scope.status =='' || $scope.deposited =='' || $scope.received == '')
    {
      error = true;
    }
    if(error == true)
    ...
    angular.element(".preloader").show();
    var obj = { project:$scope.project, client :$scope.client,amount:$scope.amount,status:$scope.status,currencyId:$scope.currency,milestoneId:$scope.milestone,date:$scope.date,deposited:$scope.deposited,received:$scope.received};
  ...
  $scope.updateincome = function()
  {
    ...
    if($scope.client1 == '' || $scope.project1 == '' ||  $scope.amount1 == '' || $scope.currency1 == ''  || $scope.date1 == '' || $scope.status1 =='' || $scope.deposited1 == '' || $scope.received1 == '')
    {
      error = true;
    }
    ...
    angular.element(".preloader").show();
    var obj = { incomeId:$scope.editincomedata.incomeId, client :$scope.client1,project:$scope.project1,amount:$scope.amount1,status:$scope.status1,currencyId:$scope.currency1,deposited:$scope.deposited1,date:$scope.date1,received:$scope.received1};
...
// jobopening
    ...
    {
      var obj = { page :$scope.page,search:$scope.searchname };
      $http({
    ...
    $scope.saverecruitment = function()
    {
      ...
      if($scope.name == '' || $scope.email == '' || $scope.phone == '' || $scope.gender == '' || $scope.experience == '' || $scope.current == '' || $scope.expected =='' || $scope.skill == '' || $scope.period == '' || $scope.birth == '' || $scope.cv == '' || $scope.currency =='' )
      {
        error = true;
      }
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.submitl = false;
          $scope.getrecruitment();
        $.notify("Recruitment Added Successfully", "success");
        }
    ...
    $scope.delete = function()
    {
      ...
      $http({
        ...
        {
          angular.element('#Delete').modal('hide');
          $.notify("Recruitment Deleted Successfully", "success");
          $scope.page = 1;
          $scope.getrecruitment();
        }
      });
    ...
    $scope.update = function()
    {
      ...
      if($scope.name1 == '' || $scope.email1 == '' || $scope.phone1 == '' || $scope.gender1 == '' || $scope.experience1 == '' || $scope.current1 == '' || $scope.expected1 =='' || $scope.skill1 == '' || $scope.period1 == '' || $scope.birth1 == '' || $scope.cv1 == '' || $scope.currency1 == '' )
      {
        error = true;
      }
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
          ...
          $scope.submitl = false;
          $scope.getrecruitment();
        $.notify("Recruitment Updated Successfully", "success");
        }
    ...
    {
      var obj = { page :$scope.page,position:$scope.sposition,status:$scope.sstatus };
      $http({
    ...
    $scope.saveinterview = function()
    {
      ...
      if($scope.candidate == '' || $scope.position == '' || $scope.Interviewer == '' || $scope.time == '' || $scope.date == ''  )
      {
        error = true;
      }
      // var isValid = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test($scope.time);
      ...
      var obj = { candidateId :$scope.candidate,vacancyId  :$scope.position,employeeId :$scope.Interviewer,interviewTime  :$scope.time,interviewDate  :$scope.date };
      angular.element('.preloader').show();
      $http({
    ...
    $scope.update = function()
    {
     ...
     if($scope.candidate1 == '' || $scope.position1 == '' || $scope.Interviewer1 == '' || $scope.time1 == '' || $scope.date1 == '' || $scope.status == '' || $scope.feedback == ''  )
      {
        error = true;
      }
     ...
     if(error == true)
      ...
      var obj = { interviewId:$scope.edit.interviewId,candidateId :$scope.candidate1,vacancyId  :$scope.position1,employeeId :$scope.Interviewer1,interviewTime  :$scope.time1,interviewDate  :$scope.date1,interviewStatus:$scope.status,interviewFeedback:$scope.feedback };
      angular.element('.preloader').show();
      $http({
    ...
    $scope.editInterview = function(id)
    {
      ...
      $http({
        ...
        if(response.data.message == "true")
        {
           angular.element('#Edit').modal('show');
           $scope.edit = response.data.result;
           $scope.feedback =$scope.edit.interviewFeedback1;
          }
      });
    }
    ...
    $scope.update = function()
    {
      ...
      var obj = { interviewId:$scope.edit.interviewId,interviewFeedback1:$scope.feedback,interviewDate:$scope.edit.interviewDate };
      angular.element('.preloader').show();
      $http({
        url: '<?php echo base_url(); ?>freelancer/interviewUpdate',
        method: "POST",
  ...
  $scope.get();
    ...
    $scope.get = function()
    {
      var obj = { page :$scope.page,employee:$scope.semployee,reviwer:$scope.sreviewer };
    ...
    $scope.submit = function()
    {
     ...
     // $scope.reviewperiodstart == '' || $scope.reviewperiodend == '' || $scope.qualite == 0 ||
      if($scope.department == '' || $scope.date == '' || $scope.employee == '' || $scope.jobTitle =='' || $scope.selectedreviwer == 0 ||   $scope.project =='' || $scope.reviewperiodstart == '' || $scope.reviewperiodend =='' )
      {
        error = true;
      }
      ...
      var obj = { employeeId:$scope.employee,departmentId :$scope.department,perJobTitle :$scope.jobTitle,perReviwerId :$scope.selectedreviwer,perProject:$scope.project,date:$scope.date,perReviewPeriodStart:$scope.reviewperiodstart,perReviewPeriodEnd:$scope.reviewperiodend };
      angular.element('.preloader').show();
      $http({
   ...
   $scope.save = function()
   {
     ...
     $http({
       ...
       if(response.data.success == "true")
       {
         ...
         $scope.submitl = false;
       $.notify("Employee Incrment Added Successfully", "success");
       }
...
$scope.save = function ()
{
  ...
  if( $scope.basicprice == '' ||  $scope.standardprice == ''  || $scope.premiumprice == '')
  {
    error = true;
  }


  if($scope.basicduration == '' || $scope.basicexplain == '' || $scope.standardduration == '' || $scope.standardexplain == '' || $scope.premiumduration == '' || $scope.premiumexplain =='' )
  {
    error = true;
  }
  ...
  // for( var res in $scope.task)
  // {
  //   if($scope.task[res]['task'] == '' || $scope.task[res]['duration'] == '' || $scope.task[res]['price'] == ''   )
  //   {
  //     error = true;
  //   }
  // }
  ...
  var obj = { title:$scope.title,image:$scope.image,currencyId:$scope.currency,description:$scope.description,industryId:$scope.industry,servicesId:$scope.services,basic:$scope.basic,standard:$scope.standard,premium:$scope.premium,basicDescription:$scope.basicdescription,basicPrice:$scope.basicprice,standardDescription:$scope.standarddescription,premiumDescription:$scope.premiumdescription,premiumPrice:$scope.premiumprice,basicDuration:$scope.basicduration,basicExplain:$scope.basicexplain,standardDuration:$scope.standardduration,standardExplain:$scope.standardexplain,premiumDuration:$scope.premiumduration,premiumExplain:$scope.premiumexplain,task:$scope.task};
  $http({
...
$scope.basicadd = function ($event)
 ...
 $http({
   ...
   if(response.data.message == "true")
   {
     ...
     $scope.basicdescription = $scope.editdata.basicDescription;
     $scope.basicprice = $scope.editdata.basicPrice;
     $scope.standarddescription = $scope.editdata.standardDescription;
     $scope.standardprice = $scope.editdata.standardPrice;
     $scope.premiumdescription =  $scope.editdata.premiumDescription;
     $scope.premiumprice = $scope.editdata.premiumPrice;
     $scope.basicduration = $scope.editdata.basicDuration;
     $scope.basicexplain = $scope.editdata.basicExplain;
     $scope.standardduration = $scope.editdata.standardDuration;
     $scope.standardexplain = $scope.editdata.standardExplain;
     $scope.premiumexplain = $scope.editdata.premiumExplain;
     $scope.premiumduration = $scope.editdata.premiumDuration;
     $scope.currency = $scope.editdata.currencyId;
     $scope.image = $scope.editdata.image;


     $scope.b = $scope.editdata.basic;
     $scope.s = $scope.editdata.standard;
     $scope.p = $scope.editdata.premium;
     $scope.t = $scope.editdata.task;

     if($scope.b)
     {
        $scope.basic = [];
       for(var i in $scope.b)
       {
         $scope.basic.push({
          task : $scope.b[i]['task'],
          plan : $scope.b[i]['plan'],
...
// $scope.basicdescription == '' || || $scope.standarddescription == '' $scope.premiumdescription == ''
  if( $scope.basicprice == ''  || $scope.standardprice == '' || $scope.premiumprice == '')
  {
    error = true;
  }
  ...
  var obj = { gigId:$scope.editdata.gigId,image:$scope.image,currencyId:$scope.currency,title:$scope.title,description:$scope.description,industryId:$scope.industry,servicesId:$scope.services,basic:$scope.basic,standard:$scope.standard,premium:$scope.premium,basicDescription:$scope.basicdescription,basicPrice:$scope.basicprice,standardDescription:$scope.standarddescription,premiumDescription:$scope.premiumdescription,premiumPrice:$scope.premiumprice,basicDuration:$scope.basicduration,basicExplain:$scope.basicexplain,standardDuration:$scope.standardduration,standardExplain:$scope.standardexplain,premiumDuration:$scope.premiumduration,premiumExplain:$scope.premiumexplain,task:$scope.task};
  $http({
