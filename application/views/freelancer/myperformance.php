...
<div id="wrapper" class="content-wrapper">
  ...
  <section class="content portfolio-cont">
    <div class=" no-margin user-dashboard-container">
      <div ng-cloak  ng-app="myApp92" ng-controller="myCtrt92">
        <div id="content">
                    ...
                    <table class="table  table-condensed">
                      ...
                      <tbody>
                        ...
                        <tr ng-if="all.length != 0" ng-repeat="(key,x) in all">
                          ...
                          <td>{{ x.date | date }}</td>
                          <td>
                            <a href="<?php echo base_url(); ?>my-performance-add/{{ x.performance_reviewerid }}" class="btn btn-success mb-0">View Performance</a>
