          ...
          <div class="no-border-radius">
            <div class="row">
               ...
               <h3 class="p-2">Income Current month</h3>
                  <div class="box-header with-border px-2">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-2">
                       <div class="form-group">
                         <input  ng-model="startdate" type="text" class="form-control first datef" placeholder="Start Date" >
                       </div>
                     </div>
                     <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" ng-value="client"  id="client" class="form-control" ng-model="client" >
                           ...
                           <div class="form-group">
                              ...
                              <input type="text"  id="project" class="project form-control" ng-value="project" ng-model="project">
              ...
              <div ng-if="show == 0" class="box" ng-if="allex.length != 0" ng-repeat="(key1,x) in allex">
                  ...
                  <div class="p-3 mt-2"><div class="row">
                          <div class="col-md-2">
              ...
              <div ng-if="show == 1" class="box">
                  <div class="box-body bg-white">
                      ...
                      <h4 ng-if="searchtotal != 0">Amount Total: {{ searchtotal }}</h4>
