...
<section class="content portfolio-cont leave-list">
   <div class=" no-margin user-dashboard-container">
        <div ng-cloak  ng-app="myApp41" ng-controller="myCtrt41">
          <div id="content">
            ...
            <div class="row">
               ...
               <div class="row">
                   <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                         <div class="form-group">
                           <input type="text" mydatepicker="" placeholder="Please select date" readonly ng-model="date" ng-value="date" class="form-control leavedate">
                         </div>
                         </div>
                      <div class="col-md-1">
                         <div class="form-group">
                         ...
                         <div class="col-md-1">
                            <div class="form-group">
                              <input type="button" value="Reset" ng-click="reset()" class="btn btn-success">
                            </div>
                            </div>
                      </div>
                    <div class="box">
                                     ...
                                     <thead>
                                       ...
                                       <th>Leave Status</th>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                           <div class="form-group">
                                           <select ng-disabled="x.disabled" onchange="angular.element(this).scope().leaveassign(this)" ng-model="x.reviewerId" class="form-control">
                                             <option value="">Select Reviewer</option>
                                             <option   ng-repeat="(key,x2) in allteam"  data-id="{{ x.id }}"  ng-if="x.employeeId != x2.u_id" value="{{ x2.u_id }}">{{ x2.name }}</option>
                                           </select>
                                         </div>
                                         </td>

                                         <td class="btn-list">
                                         <a  ng-if="x.employeeId != '<?php echo $this->session->userdata['clientloggedin']['id']; ?>' && x.status == 0"  ng-click="confirm(1,x.id,x.employeeId)" class="btn bg-green">Approve</a>
                                         <a  ng-if="x.employeeId != '<?php echo $this->session->userdata['clientloggedin']['id']; ?>' && x.status == 0" ng-click="confirm(2,x.id,x.employeeId)" class="btn btn-danger" >Decline</a>
                                         <a  ng-if="x.reason" ng-click="rejectionreason(x.id)" class="btn bg-green" >Rejection Reason</a>
