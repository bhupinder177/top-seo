...
var obj = {  offerId : offerid,user:user,from:from,message:$scope.message,jobId:jobId,status:status }
angular.element(".preloader").show();
$http({
  url: '<?php echo base_url(); ?>freelancer/jobMesaage',
  method: "POST",
...
$scope.viewtask = function(id)
{
 ...
 $scope.reassignsubmit = function()
 {
   ...
   var obj = { id:$scope.id,dept:$scope.department1,assignedTo:$scope.team1,status:'2',name:$scope.name1,startDate:$scope.date1,dueDate:$scope.duedate1};
