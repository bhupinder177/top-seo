...
<div  id="wrapper" class="content-wrapper task-manage">
  ...
  <h4>Pending Task : {{ pendingtask }}</h4> -->
   ...
   <section ng-cloak ng-app="myApp56" ng-controller="myCtrt56" id="candidatesection" class="content dep-cstm">
            ...
            <div id="content">
                  <div class="row">
                     <div class="col-md-12">
                       ...
                       <li>
                       <a data-toggle="tab"  class="active show" href="#hrcandidate">Candidates List</a>
                       </li>
                       <li >
                      <a data-toggle="tab" href="#outercandidate">Outer Candidate</a>
                      </li>
                       </ul>
                       	<div class="tab-content">
                          <!-- Overdue task -->
                          <div id="hrcandidate"  class="tab-pane fade in active show  membership-table">
                        <div class="box bg-white c-pass-sec">
                               ...
                               <div class="col-lg-8 col-md-12">
                                 <div class="row">
                                   <div class="col-md-2">
                                      ...
                                      <div class="col-md-3">
                                         <div class="form-group">
                                           <select ng-model="statussearch" convert-to-number onchange="angular.element(this).scope().searchStatus(this)" class="form-control">
                                             <option value="">Select Status</option>
                                             <option value="2">Yet To Decide</option>
                              ...
                              <table id="rankingTable" class="table table-condensed">
                                 ...
                                 <tbody>
                                   <tr ng-if="allrecruitment.length != 0" ng-repeat="(key,x) in allrecruitment">
                                     ...
                                     <span ng-if="x.candidateStatus == 2">Yet to Decide</span>
                          ...
                          <!-- outer candidate -->
                          <div id="outercandidate"  class="tab-pane fade in  membership-table">
                        <div class="box bg-white c-pass-sec">
                           <div class="box-header">
                             <!-- row -->
                             <div class="row">
                               <div class="col-lg-8 col-md-12">
                                 <div class="row">
                                   <div class="col-md-2">
                                      <div class="form-group">
                                        <select ng-model="outerperpage" convert-to-number onchange="angular.element(this).scope().changeouterPerPage(this)" class="form-control">
                                          <option value="10">10</option>
                                          <option value="20">20</option>
                                          <option value="50">50</option>
                                          <option value="100">100</option>
                           ...
                           <div ng-cloak class="box-body todotabledata">
                               <div class="table-responsive">
                                 ...
                                 <tbody>
                                   <tr ng-if="alloutercandidate.length != 0" ng-repeat="(key,x) in alloutercandidate">
                                     <td>{{ outerstart + $index }}</td>
                                     <td>{{ x.candidateName  }}</td>
                                     <td>{{ x.candidateEmail  }}</td>
                                     <td>{{ x.candidatePhone   }}</td>
                                     <td>{{ x.candidateExperience  }}</td>
                                   ...
                                   <tr ng-if="alloutercandidate.length == 0"><td colspan="9" class="text-center">No Record Found.</td></tr>

                                 </tbody>

                               </table>
                               <div  id="outerpagination"></div>
                           ...
                           <div class="form-group ">
                             ...
                             <p ng-show="submitl && status == ''" class="text-danger">Please select status.</p>
                                ...
                                <div class="form-group ">
                                  ...
                                  <input type="text" id="period" placeholder="Please enter notice period" class="form-control specialcharacter" name="period" ng-value="period" ng-model="period">
                                ...
                                <div class="form-group ">
                                  ...
                                  <select id="vacancyId" class="form-control" name="vacancyId" ng-value="vacancyId" ng-model="vacancyId">
                                    <option value="">Select Position</option>

                                    <option ng-repeat="(key,x) in allopening" value="{{ x.vacancyId }}">{{ x.vacancyPosition }}</option>

                                  </select>
                                  <p ng-show="submitl && vacancyId == ''" class="text-danger">Please select position.</p>
                                </div>
                                  </div>
                       ...
                       <div class="modal-content">
                         ...
                         <div class="form-group ">
                           ...
                           <div class="form-group ">
                             ...
                             <span ng-if="view.candidateStatus  == 2">Yet to Decide</span>
                           </div>
                         </div>
                         <div class="modal-footer">
                     ...
                     <div class="modal-dialog">
                       ...
                       <div class="modal-content">
                         ...
                         <div class="modal-body">
                           ...
                           <div class="form-group ">
                             <label for="name" class="m-0">Experience <span class="red-text">*</span></label>
                             <input type="text" id="experience1" class="form-control specialcharacter" name="experience1" ng-value="experience1" ng-model="experience1">
                           ...
                           <div class="form-group ">
                             ...
                             <div class="col-md-6">
                               ...
                               <div class="form-group ">
                                ...
                                <div class="form-group ">
                                  <label for="name" class="m-0">Position<span class="red-text">*</span></label>
                                  <select id="vacancyId" class="form-control" name="vacancyId1" ng-value="vacancyId1" ng-model="vacancyId1">
                                    <option value="">Select Position</option>
                                    <option ng-repeat="(key,x) in allopening" value="{{ x.vacancyId }}">{{ x.vacancyPosition }}</option>
                                  </select>
                                  <p ng-show="submitl && vacancyId1 == ''" class="text-danger">Please select position.</p>
                                </div>
                                  </div>
                           ...
                           <div class="form-group ">
                             <label for="name" class="m-0">Notice Period <span class="red-text">*</span></label>
                             <input type="text" id="period1" placeholder="Please enter notice period" class="form-control specialcharacter" name="period1" ng-value="period1" ng-model="period1">
                             ...
                             <div class="col-md-6">
                                   ...
                                   <div class="form-group ">
                                     <label for="name" class="m-0">Status {{ x.status1 }}<span class="red-text">*</span></label>
                                     <select onchange="angular.element(this).scope().statusChange(this)" ng-if="status1 == 2" type="text" id="status1" class="form-control status1" name="status1"  ng-model="status1">
                                       <option value="">Select Status</option>
                                       <option value="1">Approved</option>
                                       <option value="0">Rejected</option>
                                       <option  value="2">Yet to Decide</option>
