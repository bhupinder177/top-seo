	...
	<tbody>
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" style="background:#fff; box-shadow:0 0 10px #ccc;" width="600">
              ...
              <img width="150px" src="<?php echo base_url().'assets/front/images/assets/front/images/top-seo.png'; ?>" alt="">
            </td>
					</tr>
					<tr>
						<td>
							...
							<tbody>
								<tr>
                                    ...
                                    <td>
																			 Hi <?php echo $name; ?>,
																			 <br/>
																			<p>You are registered with chdmart customer account.To click on below button to activate the account.<br><br>
