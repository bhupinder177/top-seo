							...
							<tbody>
								<tr>
                                    ...
                                    <td>
																			 Hi <?php echo $name; ?>,
																			 <br/>
																		<p>Your bill has been generated for <?php echo $invoiceno; ?> and Total Payable Amount is <?php echo $currency; ?> <?php echo $payable; ?> on <?php echo date("d-m-Y", strtotime($date));  ?>.</p><br>
																		<p>Find the attached invoice pdf.</p>

																	<p>If you have any queries about the Invoice, then please contact us on email or number given on the Invoice.</p>
