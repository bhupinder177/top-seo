														...
														<tr>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tbody>
																	<tr>
                                                                        <td>
																			<h6> Hi <b><?php echo $name; ?>,</b></h6>
																			 <br/>
																		<p style="font-size: 14px;">Congratulations!!</p>
                               <p style="font-size: 14px;">One more project has been added in your project list.</p>
                              <p> Project Name - <?php echo $projectname; ?> assigned by <?php echo $sales; ?>.</p>
                             <p>To check Project Details, please <a href="<?php echo base_url(); ?>login">click here</a> to login.</p><br/>
