																	...
																	<tr>
                                                                        <td>
																			 ...
																			 <?php if($result->status == 1)
																			     {
																				   ?>
																		   <p style="font-size: 14px;">Your <?php echo $result->remark; ?> Leave on this <?php echo $result->date; ?> has been accepted.</p><br/>

																		 <?php }
                                        else if($result->status == 2)
																				{
																		  ?>
																			<p style="font-size: 14px;"> Your <?php echo $result->remark; ?> Leave on this <?php echo $date = date("m-d-Y", strtotime($result->date));  ?> has been rejected.</p><br/>

																		<?php }
																		      else if($result->status == 3)
																					{
																						?>
																						<p style="font-size: 14px;"> Your <?php echo $result->remark; ?> Leave on this <?php echo $date = date("m-d-Y", strtotime($result->date));  ?> has been Canceled.</p><br/>
