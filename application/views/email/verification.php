							...
							<tbody>
								<tr>
                                    ...
                                    <td>
																			 Hi <?php echo $name; ?>,
																			 <br/>
																			<p> Thanks for Signing up with TOP-SEOs.com</p>
        <p style="font-size: 14px;">We would like to update you that still your account is not activated. Please click below link to activate your account. </p>

				<b><a style='display: block;width: 223px;height: 14px;background: #4E9CAF;padding: 10px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-decoration:none;' class='click' href="<?php echo $link; ?>">
				 Click here to Activate</a><b>
        <p style="font-size: 14px;">If you have any doubts or queries you can contact us via Support Chat.</p>
				<br/>
				<br/>Thank You,<br/>
				 Top-SEOs Team</br>
