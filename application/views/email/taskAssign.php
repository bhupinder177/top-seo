																...
																<tbody>
																	<tr>
                                                                        <td>
																			 ...
																			 <br/>
																		<p style="font-size: 14px;">Congrats!</p><br/>
                                    <p style="font-size: 14px;"><?php $projectmanager; ?>, assigned 1 more project <project name>.</p><br/>
                                    <p style="font-size: 14px;">Good Luck!</p><br/>
